...
{
	internal class HybridBundlesTreeView : TreeViewWithTreeModel<HybridBundlesTreeElement>
	{
		...
		public HybridBundlesTreeView(TreeViewState state, MultiColumnHeader multicolumnHeader, BaseTreeModel<HybridBundlesTreeElement> model) : base(state, multicolumnHeader, model)
		{
		...
		IOrderedEnumerable<TreeViewItem<HybridBundlesTreeElement>> InitialOrder(IEnumerable<TreeViewItem<HybridBundlesTreeElement>> myTypes, int[] history)
		{
				...
				case MyColumns.FolderBundleType:
					{
						if (item.data.isFolder)
						{
							...
							item.data.folderBundleType = EditorGUI.Popup(cellRect, item.data.folderBundleType, HybridBundlesConsts.BundlePackageOptions);
							/*
							...
							switch (item.data.folderBundleType)
							{
								...
								case (int)HybridBundlesConsts.BundlePackageType.FOLDER_ALL_IN_ONE_RECURSIVELY:
									if (item.data.hasChildren)
									{
										...
										{
											child.SetFolderBundleTypeAndDeepChildren(HybridBundlesConsts.BundlePackageType.NONE);
										}
									}
									break;
							}
	...
	{
		public static string DATA_PATH = "Assets/HybridBundlesData.asset";
