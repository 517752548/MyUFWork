...
public class UnityEngine_Timeline_TimelineAssetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetRootTrack", new LuaCSFunction(GetRootTrack));
		L.RegFunction("GetRootTracks", new LuaCSFunction(GetRootTracks));
		L.RegFunction("GetOutputTrack", new LuaCSFunction(GetOutputTrack));
		L.RegFunction("GetOutputTracks", new LuaCSFunction(GetOutputTracks));
		...
		L.RegFunction("CreateMarkerTrack", new LuaCSFunction(CreateMarkerTrack));
		L.RegFunction("CreateTrack", new LuaCSFunction(CreateTrack));
		L.RegFunction("DeleteClip", new LuaCSFunction(DeleteClip));
		L.RegFunction("DeleteTrack", new LuaCSFunction(DeleteTrack));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Timeline_TimelineAsset));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("editorSettings", new LuaCSFunction(get_editorSettings), null);
		L.RegVar("duration", new LuaCSFunction(get_duration), null);
		L.RegVar("fixedDuration", new LuaCSFunction(get_fixedDuration), new LuaCSFunction(set_fixedDuration));
		L.RegVar("durationMode", new LuaCSFunction(get_durationMode), new LuaCSFunction(set_durationMode));
		L.RegVar("outputs", new LuaCSFunction(get_outputs), null);
		L.RegVar("clipCaps", new LuaCSFunction(get_clipCaps), null);
		L.RegVar("outputTrackCount", new LuaCSFunction(get_outputTrackCount), null);
		L.RegVar("rootTrackCount", new LuaCSFunction(get_rootTrackCount), null);
		L.RegVar("markerTrack", new LuaCSFunction(get_markerTrack), null);
		L.EndClass();
	}
	...
	static int set_durationMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Timeline.TimelineAsset obj = (UnityEngine.Timeline.TimelineAsset)o;
			UnityEngine.Timeline.TimelineAsset.DurationMode arg0 = (UnityEngine.Timeline.TimelineAsset.DurationMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Timeline.TimelineAsset.DurationMode>.type);
