...
public class UnityEngine_UI_LayoutUtilityWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetMinSize", new LuaCSFunction(GetMinSize));
		L.RegFunction("GetPreferredSize", new LuaCSFunction(GetPreferredSize));
		L.RegFunction("GetFlexibleSize", new LuaCSFunction(GetFlexibleSize));
		L.RegFunction("GetMinWidth", new LuaCSFunction(GetMinWidth));
		L.RegFunction("GetPreferredWidth", new LuaCSFunction(GetPreferredWidth));
		L.RegFunction("GetFlexibleWidth", new LuaCSFunction(GetFlexibleWidth));
		L.RegFunction("GetMinHeight", new LuaCSFunction(GetMinHeight));
		L.RegFunction("GetPreferredHeight", new LuaCSFunction(GetPreferredHeight));
		L.RegFunction("GetFlexibleHeight", new LuaCSFunction(GetFlexibleHeight));
		L.RegFunction("GetLayoutProperty", new LuaCSFunction(GetLayoutProperty));
		L.EndStaticLibs();
	}
