...
public class UnityEngine_SceneManagement_SceneManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetActiveScene", new LuaCSFunction(GetActiveScene));
		L.RegFunction("SetActiveScene", new LuaCSFunction(SetActiveScene));
		L.RegFunction("GetSceneByPath", new LuaCSFunction(GetSceneByPath));
		L.RegFunction("GetSceneByName", new LuaCSFunction(GetSceneByName));
		L.RegFunction("GetSceneByBuildIndex", new LuaCSFunction(GetSceneByBuildIndex));
		L.RegFunction("GetSceneAt", new LuaCSFunction(GetSceneAt));
		L.RegFunction("CreateScene", new LuaCSFunction(CreateScene));
		L.RegFunction("MergeScenes", new LuaCSFunction(MergeScenes));
		L.RegFunction("MoveGameObjectToScene", new LuaCSFunction(MoveGameObjectToScene));
		L.RegFunction("LoadScene", new LuaCSFunction(LoadScene));
		L.RegFunction("LoadSceneAsync", new LuaCSFunction(LoadSceneAsync));
		L.RegFunction("UnloadSceneAsync", new LuaCSFunction(UnloadSceneAsync));
		L.RegVar("sceneCount", new LuaCSFunction(get_sceneCount), null);
		L.RegVar("sceneCountInBuildSettings", new LuaCSFunction(get_sceneCountInBuildSettings), null);
		L.RegVar("sceneLoaded", new LuaCSFunction(get_sceneLoaded), new LuaCSFunction(set_sceneLoaded));
		L.RegVar("sceneUnloaded", new LuaCSFunction(get_sceneUnloaded), new LuaCSFunction(set_sceneUnloaded));
		L.RegVar("activeSceneChanged", new LuaCSFunction(get_activeSceneChanged), new LuaCSFunction(set_activeSceneChanged));
		L.EndStaticLibs();
	}
