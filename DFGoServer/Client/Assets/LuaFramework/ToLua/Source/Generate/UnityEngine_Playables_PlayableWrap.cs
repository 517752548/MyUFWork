...
public class UnityEngine_Playables_PlayableWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetHandle", new LuaCSFunction(GetHandle));
		L.RegFunction("GetPlayableType", new LuaCSFunction(GetPlayableType));
		L.RegFunction("Equals", new LuaCSFunction(Equals));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Playables_Playable));
	...
	static int GetHandle(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Playables.Playable obj = (UnityEngine.Playables.Playable)ToLua.CheckObject(L, 1, TypeTraits<UnityEngine.Playables.Playable>.type);
