...
public class UnityEngine_UI_TextWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOText", new LuaCSFunction(DOText));
	...
	static int DOText(IntPtr L)
	{
		try
		{
			...
			if (count == 3)
			{
				...
				DG.Tweening.Tweener o = obj.DOText(arg0, arg1);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 4)
			{
				...
				DG.Tweening.Tweener o = obj.DOText(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
				bool arg2 = LuaDLL.luaL_checkboolean(L, 4);
				DG.Tweening.ScrambleMode arg3 = (DG.Tweening.ScrambleMode)ToLua.CheckObject(L, 5, TypeTraits<DG.Tweening.ScrambleMode>.type);
				DG.Tweening.Tweener o = obj.DOText(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 6)
