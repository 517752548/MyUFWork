...
public class UnityEngine_Video_VideoPlayerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("StepForward", new LuaCSFunction(StepForward));
		L.RegFunction("GetAudioLanguageCode", new LuaCSFunction(GetAudioLanguageCode));
		L.RegFunction("GetAudioChannelCount", new LuaCSFunction(GetAudioChannelCount));
		L.RegFunction("GetAudioSampleRate", new LuaCSFunction(GetAudioSampleRate));
		L.RegFunction("EnableAudioTrack", new LuaCSFunction(EnableAudioTrack));
		L.RegFunction("IsAudioTrackEnabled", new LuaCSFunction(IsAudioTrackEnabled));
		L.RegFunction("GetDirectAudioVolume", new LuaCSFunction(GetDirectAudioVolume));
		L.RegFunction("SetDirectAudioVolume", new LuaCSFunction(SetDirectAudioVolume));
		L.RegFunction("GetDirectAudioMute", new LuaCSFunction(GetDirectAudioMute));
		L.RegFunction("SetDirectAudioMute", new LuaCSFunction(SetDirectAudioMute));
		L.RegFunction("GetTargetAudioSource", new LuaCSFunction(GetTargetAudioSource));
		L.RegFunction("SetTargetAudioSource", new LuaCSFunction(SetTargetAudioSource));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Video_VideoPlayer));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("source", new LuaCSFunction(get_source), new LuaCSFunction(set_source));
		...
		L.RegVar("targetCamera", new LuaCSFunction(get_targetCamera), new LuaCSFunction(set_targetCamera));
		L.RegVar("targetTexture", new LuaCSFunction(get_targetTexture), new LuaCSFunction(set_targetTexture));
		L.RegVar("targetMaterialRenderer", new LuaCSFunction(get_targetMaterialRenderer), new LuaCSFunction(set_targetMaterialRenderer));
		L.RegVar("targetMaterialProperty", new LuaCSFunction(get_targetMaterialProperty), new LuaCSFunction(set_targetMaterialProperty));
		L.RegVar("aspectRatio", new LuaCSFunction(get_aspectRatio), new LuaCSFunction(set_aspectRatio));
		L.RegVar("targetCameraAlpha", new LuaCSFunction(get_targetCameraAlpha), new LuaCSFunction(set_targetCameraAlpha));
		L.RegVar("targetCamera3DLayout", new LuaCSFunction(get_targetCamera3DLayout), new LuaCSFunction(set_targetCamera3DLayout));
		L.RegVar("texture", new LuaCSFunction(get_texture), null);
		L.RegVar("isPrepared", new LuaCSFunction(get_isPrepared), null);
		L.RegVar("waitForFirstFrame", new LuaCSFunction(get_waitForFirstFrame), new LuaCSFunction(set_waitForFirstFrame));
		...
		L.RegVar("canSetTime", new LuaCSFunction(get_canSetTime), null);
		...
		L.RegVar("clockTime", new LuaCSFunction(get_clockTime), null);
		L.RegVar("canStep", new LuaCSFunction(get_canStep), null);
		L.RegVar("canSetPlaybackSpeed", new LuaCSFunction(get_canSetPlaybackSpeed), null);
		L.RegVar("playbackSpeed", new LuaCSFunction(get_playbackSpeed), new LuaCSFunction(set_playbackSpeed));
		L.RegVar("isLooping", new LuaCSFunction(get_isLooping), new LuaCSFunction(set_isLooping));
		L.RegVar("canSetTimeSource", new LuaCSFunction(get_canSetTimeSource), null);
		L.RegVar("timeSource", new LuaCSFunction(get_timeSource), new LuaCSFunction(set_timeSource));
		L.RegVar("timeReference", new LuaCSFunction(get_timeReference), new LuaCSFunction(set_timeReference));
		L.RegVar("externalReferenceTime", new LuaCSFunction(get_externalReferenceTime), new LuaCSFunction(set_externalReferenceTime));
		L.RegVar("canSetSkipOnDrop", new LuaCSFunction(get_canSetSkipOnDrop), null);
		L.RegVar("skipOnDrop", new LuaCSFunction(get_skipOnDrop), new LuaCSFunction(set_skipOnDrop));
		L.RegVar("frameCount", new LuaCSFunction(get_frameCount), null);
		L.RegVar("frameRate", new LuaCSFunction(get_frameRate), null);
		...
		L.RegVar("pixelAspectRatioNumerator", new LuaCSFunction(get_pixelAspectRatioNumerator), null);
		L.RegVar("pixelAspectRatioDenominator", new LuaCSFunction(get_pixelAspectRatioDenominator), null);
		L.RegVar("audioTrackCount", new LuaCSFunction(get_audioTrackCount), null);
		L.RegVar("controlledAudioTrackMaxCount", new LuaCSFunction(get_controlledAudioTrackMaxCount), null);
		L.RegVar("controlledAudioTrackCount", new LuaCSFunction(get_controlledAudioTrackCount), new LuaCSFunction(set_controlledAudioTrackCount));
		L.RegVar("audioOutputMode", new LuaCSFunction(get_audioOutputMode), new LuaCSFunction(set_audioOutputMode));
		L.RegVar("canSetDirectAudioVolume", new LuaCSFunction(get_canSetDirectAudioVolume), null);
		L.RegVar("sendFrameReadyEvents", new LuaCSFunction(get_sendFrameReadyEvents), new LuaCSFunction(set_sendFrameReadyEvents));
		L.RegVar("prepareCompleted", new LuaCSFunction(get_prepareCompleted), new LuaCSFunction(set_prepareCompleted));
		L.RegVar("loopPointReached", new LuaCSFunction(get_loopPointReached), new LuaCSFunction(set_loopPointReached));
		L.RegVar("started", new LuaCSFunction(get_started), new LuaCSFunction(set_started));
		L.RegVar("frameDropped", new LuaCSFunction(get_frameDropped), new LuaCSFunction(set_frameDropped));
		L.RegVar("errorReceived", new LuaCSFunction(get_errorReceived), new LuaCSFunction(set_errorReceived));
		L.RegVar("seekCompleted", new LuaCSFunction(get_seekCompleted), new LuaCSFunction(set_seekCompleted));
		L.RegVar("clockResyncOccurred", new LuaCSFunction(get_clockResyncOccurred), new LuaCSFunction(set_clockResyncOccurred));
		L.RegVar("frameReady", new LuaCSFunction(get_frameReady), new LuaCSFunction(set_frameReady));
		L.RegFunction("FrameReadyEventHandler", new LuaCSFunction(UnityEngine_Video_VideoPlayer_FrameReadyEventHandler));
		L.RegFunction("TimeEventHandler", new LuaCSFunction(UnityEngine_Video_VideoPlayer_TimeEventHandler));
		L.RegFunction("EventHandler", new LuaCSFunction(UnityEngine_Video_VideoPlayer_EventHandler));
		L.RegFunction("ErrorEventHandler", new LuaCSFunction(UnityEngine_Video_VideoPlayer_ErrorEventHandler));
		L.EndClass();
	}
	...
	static int Prepare(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)ToLua.CheckObject<UnityEngine.Video.VideoPlayer>(L, 1);
			obj.Prepare();
			return 0;
		}
		catch (Exception e)
	...
	static int SetTargetAudioSource(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)ToLua.CheckObject<UnityEngine.Video.VideoPlayer>(L, 1);
			ushort arg0 = (ushort)LuaDLL.luaL_checkinteger(L, 2);
			UnityEngine.AudioSource arg1 = (UnityEngine.AudioSource)ToLua.CheckObject<UnityEngine.AudioSource>(L, 3);
	...
	static int get_controlledAudioTrackMaxCount(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, UnityEngine.Video.VideoPlayer.controlledAudioTrackMaxCount);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_source(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoSource arg0 = (UnityEngine.Video.VideoSource)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoSource>.type);
			obj.source = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_clip(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoClip arg0 = (UnityEngine.Video.VideoClip)ToLua.CheckObject<UnityEngine.Video.VideoClip>(L, 2);
			obj.clip = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_renderMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoRenderMode arg0 = (UnityEngine.Video.VideoRenderMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoRenderMode>.type);
			obj.renderMode = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_aspectRatio(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoAspectRatio arg0 = (UnityEngine.Video.VideoAspectRatio)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoAspectRatio>.type);
	...
	static int set_targetCamera3DLayout(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.Video3DLayout arg0 = (UnityEngine.Video.Video3DLayout)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.Video3DLayout>.type);
	...
	static int set_timeSource(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoTimeSource arg0 = (UnityEngine.Video.VideoTimeSource)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoTimeSource>.type);
			obj.timeSource = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_timeReference(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoTimeReference arg0 = (UnityEngine.Video.VideoTimeReference)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoTimeReference>.type);
	...
	static int set_audioOutputMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoAudioOutputMode arg0 = (UnityEngine.Video.VideoAudioOutputMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Video.VideoAudioOutputMode>.type);
