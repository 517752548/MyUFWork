...
public class UnityEngine_UI_ScrollRect_MovementTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("Unrestricted", new LuaCSFunction(get_Unrestricted), null);
		L.RegVar("Elastic", new LuaCSFunction(get_Elastic), null);
		L.RegVar("Clamped", new LuaCSFunction(get_Clamped), null);
	...
	static Type TypeOf_UnityEngine_UI_ScrollRect_MovementType = typeof(UnityEngine.UI.ScrollRect.MovementType);

	static bool CheckType(IntPtr L, int pos)
	{
		return TypeChecker.CheckEnumType(TypeOf_UnityEngine_UI_ScrollRect_MovementType, L, pos);
	}
