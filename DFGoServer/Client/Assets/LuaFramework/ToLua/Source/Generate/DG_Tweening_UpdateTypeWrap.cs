...
public class DG_Tweening_UpdateTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("Late", new LuaCSFunction(get_Late), null);
	...
	static Type TypeOf_DG_Tweening_UpdateType = typeof(DG.Tweening.UpdateType);

	static bool CheckType(IntPtr L, int pos)
	{
		return TypeChecker.CheckEnumType(TypeOf_DG_Tweening_UpdateType, L, pos);
	}
