...
public class UnityEngine_UI_ToggleGroupWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("NotifyToggleOn", new LuaCSFunction(NotifyToggleOn));
		L.RegFunction("UnregisterToggle", new LuaCSFunction(UnregisterToggle));
		L.RegFunction("RegisterToggle", new LuaCSFunction(RegisterToggle));
		L.RegFunction("EnsureValidState", new LuaCSFunction(EnsureValidState));
		L.RegFunction("AnyTogglesOn", new LuaCSFunction(AnyTogglesOn));
		L.RegFunction("ActiveToggles", new LuaCSFunction(ActiveToggles));
		L.RegFunction("SetAllTogglesOff", new LuaCSFunction(SetAllTogglesOff));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("allowSwitchOff", new LuaCSFunction(get_allowSwitchOff), new LuaCSFunction(set_allowSwitchOff));
		L.EndClass();
	}
