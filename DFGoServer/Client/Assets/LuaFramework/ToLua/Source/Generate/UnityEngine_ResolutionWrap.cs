...
public class UnityEngine_ResolutionWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Resolution));
		...
		L.RegVar("refreshRate", new LuaCSFunction(get_refreshRate), new LuaCSFunction(set_refreshRate));
		L.EndClass();
	}
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Resolution obj = (UnityEngine.Resolution)ToLua.CheckObject(L, 1, TypeTraits<UnityEngine.Resolution>.type);
