...
public class UnityEngine_UI_GridLayoutGroupWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("startCorner", new LuaCSFunction(get_startCorner), new LuaCSFunction(set_startCorner));
		L.RegVar("startAxis", new LuaCSFunction(get_startAxis), new LuaCSFunction(set_startAxis));
		...
		L.RegVar("constraint", new LuaCSFunction(get_constraint), new LuaCSFunction(set_constraint));
		L.RegVar("constraintCount", new LuaCSFunction(get_constraintCount), new LuaCSFunction(set_constraintCount));
		L.EndClass();
	}
	...
	static int set_startCorner(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Corner arg0 = (UnityEngine.UI.GridLayoutGroup.Corner)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.GridLayoutGroup.Corner>.type);
	...
	static int set_startAxis(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Axis arg0 = (UnityEngine.UI.GridLayoutGroup.Axis)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.GridLayoutGroup.Axis>.type);
			obj.startAxis = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_constraint(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.GridLayoutGroup obj = (UnityEngine.UI.GridLayoutGroup)o;
			UnityEngine.UI.GridLayoutGroup.Constraint arg0 = (UnityEngine.UI.GridLayoutGroup.Constraint)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.UI.GridLayoutGroup.Constraint>.type);
			obj.constraint = arg0;
			return 0;
		}
		catch(Exception e)
