...
public class UnityEngine_FontWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CreateDynamicFontFromOSFont", new LuaCSFunction(CreateDynamicFontFromOSFont));
		L.RegFunction("GetMaxVertsForString", new LuaCSFunction(GetMaxVertsForString));
		L.RegFunction("HasCharacter", new LuaCSFunction(HasCharacter));
		L.RegFunction("GetOSInstalledFontNames", new LuaCSFunction(GetOSInstalledFontNames));
		L.RegFunction("GetCharacterInfo", new LuaCSFunction(GetCharacterInfo));
		L.RegFunction("RequestCharactersInTexture", new LuaCSFunction(RequestCharactersInTexture));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Font));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("material", new LuaCSFunction(get_material), new LuaCSFunction(set_material));
		L.RegVar("fontNames", new LuaCSFunction(get_fontNames), new LuaCSFunction(set_fontNames));
		L.RegVar("dynamic", new LuaCSFunction(get_dynamic), null);
		L.RegVar("ascent", new LuaCSFunction(get_ascent), null);
		L.RegVar("fontSize", new LuaCSFunction(get_fontSize), null);
		L.RegVar("characterInfo", new LuaCSFunction(get_characterInfo), new LuaCSFunction(set_characterInfo));
		L.RegVar("lineHeight", new LuaCSFunction(get_lineHeight), null);
		L.RegVar("textureRebuilt", new LuaCSFunction(get_textureRebuilt), new LuaCSFunction(set_textureRebuilt));
		L.EndClass();
	}
	...
	static int HasCharacter(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Font obj = (UnityEngine.Font)ToLua.CheckObject<UnityEngine.Font>(L, 1);
	...
	static int RequestCharactersInTexture(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				string arg0 = ToLua.CheckString(L, 2);
				int arg1 = (int)LuaDLL.luaL_checkinteger(L, 3);
				UnityEngine.FontStyle arg2 = (UnityEngine.FontStyle)ToLua.CheckObject(L, 4, TypeTraits<UnityEngine.FontStyle>.type);
