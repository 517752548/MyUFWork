...
public class UnityEngine_UI_ShadowWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("effectColor", new LuaCSFunction(get_effectColor), new LuaCSFunction(set_effectColor));
		L.RegVar("effectDistance", new LuaCSFunction(get_effectDistance), new LuaCSFunction(set_effectDistance));
		L.RegVar("useGraphicAlpha", new LuaCSFunction(get_useGraphicAlpha), new LuaCSFunction(set_useGraphicAlpha));
		L.EndClass();
	}
