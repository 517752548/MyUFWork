...
public class UnityEngine_RectOffsetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_RectOffset));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("left", new LuaCSFunction(get_left), new LuaCSFunction(set_left));
		L.RegVar("right", new LuaCSFunction(get_right), new LuaCSFunction(set_right));
		L.RegVar("top", new LuaCSFunction(get_top), new LuaCSFunction(set_top));
		L.RegVar("bottom", new LuaCSFunction(get_bottom), new LuaCSFunction(set_bottom));
