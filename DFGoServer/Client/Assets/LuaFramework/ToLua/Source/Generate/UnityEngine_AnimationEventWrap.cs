...
public class UnityEngine_AnimationEventWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_AnimationEvent));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("stringParameter", new LuaCSFunction(get_stringParameter), new LuaCSFunction(set_stringParameter));
		L.RegVar("floatParameter", new LuaCSFunction(get_floatParameter), new LuaCSFunction(set_floatParameter));
		L.RegVar("intParameter", new LuaCSFunction(get_intParameter), new LuaCSFunction(set_intParameter));
		L.RegVar("objectReferenceParameter", new LuaCSFunction(get_objectReferenceParameter), new LuaCSFunction(set_objectReferenceParameter));
		L.RegVar("functionName", new LuaCSFunction(get_functionName), new LuaCSFunction(set_functionName));
		L.RegVar("time", new LuaCSFunction(get_time), new LuaCSFunction(set_time));
		L.RegVar("messageOptions", new LuaCSFunction(get_messageOptions), new LuaCSFunction(set_messageOptions));
		L.RegVar("isFiredByLegacy", new LuaCSFunction(get_isFiredByLegacy), null);
		L.RegVar("isFiredByAnimator", new LuaCSFunction(get_isFiredByAnimator), null);
		L.RegVar("animationState", new LuaCSFunction(get_animationState), null);
		L.RegVar("animatorStateInfo", new LuaCSFunction(get_animatorStateInfo), null);
		L.RegVar("animatorClipInfo", new LuaCSFunction(get_animatorClipInfo), null);
		L.EndClass();
	}
	...
	static int set_messageOptions(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.AnimationEvent obj = (UnityEngine.AnimationEvent)o;
			UnityEngine.SendMessageOptions arg0 = (UnityEngine.SendMessageOptions)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.SendMessageOptions>.type);
