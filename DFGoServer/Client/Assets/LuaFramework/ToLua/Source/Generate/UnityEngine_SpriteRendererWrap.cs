...
public class UnityEngine_SpriteRendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOGradientColor", new LuaCSFunction(DOGradientColor));
	...
	static int DOBlendableColor(IntPtr L)
	{
		try
		{
			...
			UnityEngine.SpriteRenderer obj = (UnityEngine.SpriteRenderer)ToLua.CheckObject<UnityEngine.SpriteRenderer>(L, 1);
