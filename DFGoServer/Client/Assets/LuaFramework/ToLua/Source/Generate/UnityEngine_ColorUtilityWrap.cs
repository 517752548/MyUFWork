...
public class UnityEngine_ColorUtilityWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("TryParseHtmlString", new LuaCSFunction(TryParseHtmlString));
		L.RegFunction("ToHtmlStringRGB", new LuaCSFunction(ToHtmlStringRGB));
		L.RegFunction("ToHtmlStringRGBA", new LuaCSFunction(ToHtmlStringRGBA));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_ColorUtility));
