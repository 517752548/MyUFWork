...
public class UnityEngine_UI_ScrollRectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DOVerticalNormalizedPos", new LuaCSFunction(DOVerticalNormalizedPos));
		L.RegFunction("DOHorizontalNormalizedPos", new LuaCSFunction(DOHorizontalNormalizedPos));
		L.RegFunction("DONormalizedPos", new LuaCSFunction(DONormalizedPos));
