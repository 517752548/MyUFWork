...
public class UnityEngine_WWWFormWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("AddField", new LuaCSFunction(AddField));
		L.RegFunction("AddBinaryData", new LuaCSFunction(AddBinaryData));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_WWWForm));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("headers", new LuaCSFunction(get_headers), null);
