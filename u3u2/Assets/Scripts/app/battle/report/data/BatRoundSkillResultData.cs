...
namespace app.battle
{
    ...
    public class BatRoundSkillResultData
    {
        ...
        public void Parse(IDictionary data)
        {
            ...
            summonTargetStatusData.Parse(JsonHelper.GetDictData(BattleReportDef.REPORT_ITEM_SUMMON_PET.ToString(), data));
        ...
        public BatCharacter target
        {
            get
            {
                if (mTarget == null)
                {
                    mTarget = BattleCharacterManager.ins.GetCharacter(targetUUID);
                }
                return mTarget;
            }
        }
