 ...
 */
public class GCCorpstaskUpdate :BaseMessage
{
	/** 单个任务 */
	private QuestInfoData questInfo;

	public GCCorpstaskUpdate ()
	{
	}
	...
	{
		return (short)MessageType.GC_CORPSTASK_UPDATE;
	}
	
	public override string getEventType()
	{
		return CorpstaskGCHandler.GCCorpstaskUpdateEvent;
	}
