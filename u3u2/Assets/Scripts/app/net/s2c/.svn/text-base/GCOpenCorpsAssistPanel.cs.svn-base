 ...
 */
public class GCOpenCorpsAssistPanel :BaseMessage
{
	/** 帮派辅助技能信息 */
	private CorpsSkillInfo[] corpsSkillInfoList;

	public GCOpenCorpsAssistPanel ()
	{
	}
	...
	{
		return (short)MessageType.GC_OPEN_CORPS_ASSIST_PANEL;
	}
	
	public override string getEventType()
	{
		return CorpsGCHandler.GCOpenCorpsAssistPanelEvent;
	}
