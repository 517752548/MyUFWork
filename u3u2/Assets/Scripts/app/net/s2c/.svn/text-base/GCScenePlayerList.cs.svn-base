 ...
 */
public class GCScenePlayerList :BaseMessage
{
	/** 场景id */
	private int sceneId;
	/** 场景玩家信息 */
	...
	{
		return (short)MessageType.GC_SCENE_PLAYER_LIST;
	}
	
	public override string getEventType()
	{
		return SceneGCHandler.GCScenePlayerListEvent;
	}
