 ...
 */
public class GCScenePlayerChangedList :BaseMessage
{
	/** 场景id */
	private int sceneId;
	/** 场景玩家信息 */
	...
	{
		return (short)MessageType.GC_SCENE_PLAYER_CHANGED_LIST;
	}
	
	public override string getEventType()
	{
		return SceneGCHandler.GCScenePlayerChangedListEvent;
	}
