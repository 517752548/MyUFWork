 ...
 */
public class GCTlMonsterUpdate :BaseMessage
{
	/** 单个任务 */
	private QuestInfoData questInfo;

	public GCTlMonsterUpdate ()
	{
	}
	...
	{
		return (short)MessageType.GC_TL_MONSTER_UPDATE;
	}
	
	public override string getEventType()
	{
		return TimelimitGCHandler.GCTlMonsterUpdateEvent;
	}
