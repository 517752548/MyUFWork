 ...
 */
public class GCDay7TaskUpdate :BaseMessage
{
	/** 单个任务 */
	private QuestInfoData questInfo;

	public GCDay7TaskUpdate ()
	{
	}
	...
	{
		return (short)MessageType.GC_DAY7_TASK_UPDATE;
	}
	
	public override string getEventType()
	{
		return HumanGCHandler.GCDay7TaskUpdateEvent;
	}
