 ...
 */
public class GCBattleReadyChangedPvp :BaseMessage
{
	/** 主将唯一id */
	...
	public GCBattleReadyChangedPvp ()
	{
	}
	...
	{
		return (short)MessageType.GC_BATTLE_READY_CHANGED_PVP;
	}
	
	public override string getEventType()
	{
		return BattleGCHandler.GCBattleReadyChangedPvpEvent;
	}
