 ...
 */
public class GCThesweeneytaskUpdate :BaseMessage
{
	/** 单个任务 */
	private QuestInfoData questInfo;

	public GCThesweeneytaskUpdate ()
	{
	}
	...
	{
		return (short)MessageType.GC_THESWEENEYTASK_UPDATE;
	}
	
	public override string getEventType()
	{
		return ThesweeneytaskGCHandler.GCThesweeneytaskUpdateEvent;
	}
