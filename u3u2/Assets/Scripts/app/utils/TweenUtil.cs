...
{
    //public delegate void HoTweenCallBack(TweenEvent te);

    public static Tweener MoveTo(Transform t, Vector3 pos, float time,
        ...
        Ease ease = Ease.Linear)
    {
        ...
        return t.DOLocalMove(pos, time).OnStart(startCallback).OnComplete(completeCallback).OnUpdate(updateCallback).SetDelay(delaySeconds).SetEase(ease);
        
       
    }
     public static Sequence MoveScaleTo(Transform t, Vector3 scale ,Vector3 pos, float time,
        TweenCallback startCallback = null, 
        TweenCallback completeCallback = null, 
        TweenCallback updateCallback = null, 
        float delaySeconds = 0, 
    ...
    public static Tweener ScaleTo(Transform t, Vector3 scale, float time,
        TweenCallback startCallback = null, 
        TweenCallback completeCallback = null, 
        TweenCallback updateCallback = null, 
    ...
    public static Tweener RotateTo(Transform t, Vector3 rot, float time, RotateMode rotateMode = RotateMode.Fast,
        TweenCallback startCallback = null, 
        TweenCallback completeCallback = null, 
        TweenCallback updateCallback = null, 
