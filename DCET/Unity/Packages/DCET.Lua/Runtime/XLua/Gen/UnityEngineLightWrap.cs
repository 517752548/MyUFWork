...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 68, 31, 30);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseColorTemperature", _g_get_useColorTemperature);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseColorTemperature", _s_set_useColorTemperature);
