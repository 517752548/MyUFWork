...
{
    public DatePrefData(string key, DateTime defVal) : base(key, defVal)
    {
    }

    protected override DateTime Get(string key, DateTime defVal)
    {
        return Record.GetDate(key, defVal);
    }

    protected override void Set(string key, DateTime val)
    {
