...
namespace BetaFramework
{
    public class PathUtils
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static AssetBundleInfo GetValidAssetBundleInfo()
        {
            string result;
            if (File.Exists(Application.persistentDataPath + "/AssetbundleInfo"))
            {
                result = File.ReadAllText(Application.persistentDataPath + "/AssetbundleInfo");
            }
            else
            {
                result = File.ReadAllText(Application.streamingAssetsPath + "/Android/AssetbundleInfo");
            }
            return JsonMapper.ToObject<AssetBundleInfo>(result);
        }
    }
}