...
namespace IFix.Editor
{
    ...
    public class IFixEditor
    {
        ...
        [MenuItem("Framework/IFix/Inject", false, 1)]
        public static void InjectAssemblys()
        {
            ...
            //    {
            //        UnityEngine.Debug.LogError(inner);
            //    }
            //}
        ...
        public static void GenPatch(string assembly, string assemblyCSharpPath
            ...
            string corePath = "./Assets/Plugins/IFix.Core.dll", string patchPath = IFixMgr.patchName)
        {
        ...
        [MenuItem("Framework/IFix/Fix", false, 2)]
...
#if UNITY_2018_3_OR_NEWER
        [MenuItem("Framework/IFix/Fix(Android)", false, 3)]
        ...
        [MenuItem("Framework/IFix/Fix(IOS)", false, 4)]
        ...
        private const string patchOutputDir = "Assets/AssetsPackage/AnsycLoad/Patch/";
        static void MovePatch()
        {
            var patchPath = IFixMgr.patchName;
            if (File.Exists(patchPath))
            {
                var outPath = patchOutputDir + IFixMgr.patchName;
                if (!Directory.Exists(patchOutputDir))
                {
                    Directory.CreateDirectory(patchOutputDir);
                }
                File.Copy(patchPath, outPath, true);
            }
        }
#endif
    }
