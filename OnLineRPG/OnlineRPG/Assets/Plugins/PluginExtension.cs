...
public static class PluginExtension
{
    ...
    public static void SetRectTransformLocalX(this RectTransform transform, float x)
    {
        Vector3 anchoredPosition = new Vector3(x, transform.anchoredPosition3D.y, transform.anchoredPosition3D.z);
        transform.anchoredPosition3D = anchoredPosition;
    }

    public static void SetRectTransformLocalY(this RectTransform transform, float y)
    {
        Vector3 anchoredPosition = new Vector3(transform.anchoredPosition3D.x, y, transform.anchoredPosition3D.z);
        transform.anchoredPosition3D = anchoredPosition;
    }

    public static void SetRectTransformLocalZ(this RectTransform transform, float z)
    {
        Vector3 anchoredPosition = new Vector3(transform.anchoredPosition3D.x, transform.anchoredPosition3D.y, z);
        transform.anchoredPosition3D = anchoredPosition;
    }
