...
namespace UnityEngine.UI
{
    ...
    public class LoopVerticalScrollRect : LoopScrollRect
    {
        ...
        {
            bool changed = false;
            if (viewBounds.min.y < contentBounds.min.y + headViewHeight)
            {
            ...
            else if (viewBounds.min.y > contentBounds.min.y + threshold + 2048)
            {
            ...
            if (viewBounds.max.y > contentBounds.max.y - headViewHeight) 
            {
            ...
            else if (viewBounds.max.y < contentBounds.max.y - threshold - 2048)
            {
