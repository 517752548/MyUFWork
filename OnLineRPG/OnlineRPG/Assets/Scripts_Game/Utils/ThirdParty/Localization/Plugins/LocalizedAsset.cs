...
public class LocalizedAsset : MonoBehaviour
{
    ...
    public static void LocalizeAsset(Object target)
    {
        if (target == null)
        {
            BetaFramework.LoggerHelper.Error("LocalizedAsset target is null");
            return;
        }
        ...
        //    if (gT.texture != null)
        //    {
        //        Texture text = (Texture)LanguageManager.GetAsset(gT.texture.name);
        //        if (text != null)
        //            gT.texture = text;
        //    }
        //}
        ...
        //    {
        //        Texture text = (Texture)LanguageManager.GetAsset(mainT.mainTexture.name);
        //        if (text != null)
        ...
        //    {
        //        Texture text = (Texture)LanguageManager.GetAsset(mainT.material.mainTexture.name);
        //        if (text != null)
        ...
        //else
        //{
        //    BetaFramework.LoggerHelper.Error("Could not localize this object type: " + target.GetType());
        //}
    }
