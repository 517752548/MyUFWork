...
public class LanguageEditor : EditorWindow
{
	...
	static string settingsAssetPath = "Assets/ThirdParty/Localization/Resources/Languages/LocalizationSettings.asset";
    public LocalizationSettings settings;// = (LocalizationSettings)AssetDatabase.LoadAssetAtPath(settingsAssetPath, typeof(LocalizationSettings));
    ...
    [MenuItem("Tools/LocalizationTest")]
    static void OpenWindowTest()
    {
        Debug.Log(LanguageManager.Get("PURCHASE_SUCCESSFUL"));
       // AssetDatabase.CreateAsset((LocalizationSettings)ScriptableObject.CreateInstance(typeof(LocalizationSettings)), "Assets/ThirdParty/Localization/Resources/Languages/LocalizationSettings2.asset");
        return;
