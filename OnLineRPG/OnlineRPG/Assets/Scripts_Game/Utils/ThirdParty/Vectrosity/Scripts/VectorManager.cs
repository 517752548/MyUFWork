...
public class VectorManager {
	...
	public static void VisibilityStaticRemove (int objectNumber) {
		if (objectNumber >= vectorLines.Count) {
			BetaFramework.LoggerHelper.Error ("VectorManager: object number exceeds array length in VisibilityStaticRemove");
			return;
		}
	...
	public static void VisibilityRemove (int objectNumber) {
		if (objectNumber >= vectorLines2.Count) {
			BetaFramework.LoggerHelper.Error ("VectorManager: object number exceeds array length in VisibilityRemove");
			return;
		}
	...
	public static void DistanceRemove (int objectNumber) {
		if (objectNumber >= vectorLines3.Count) {
			BetaFramework.LoggerHelper.Error ("VectorManager: object number exceeds array length in DistanceRemove");
			return;
		}
	...
	public static Bounds GetBounds (VectorLine line) {
		if (line.points3 == null) {
			BetaFramework.LoggerHelper.Error ("VectorManager: GetBounds can only be used with a Vector3 array");
			return new Bounds();
		}
