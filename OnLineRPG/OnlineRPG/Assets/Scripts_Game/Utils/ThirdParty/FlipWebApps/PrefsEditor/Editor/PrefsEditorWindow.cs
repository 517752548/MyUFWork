...
namespace PrefsEditor.Editor
{
    ...
    public class PrefsEditorWindow : EditorWindow
    {
        ...
        void RefreshPlayerPrefs()
        {
            ...
            {
                BetaFramework.LoggerHelper.Log("This currently only works on Windows and Mac.");
            }
        ...
        void RefreshPlayerPrefsOSX()
        {
            ...
            {
                BetaFramework.LoggerHelper.Log("OSX Prefs file not found '" + prefsPath + "'");
            }
        }
    ...
    public class PlayerPrefsEntry
    {
        ...
        bool ValidateEncryptedValue(SecurePlayerPrefs.ItemType itemType, string encryptedValue)
        {
            ...
            {
                BetaFramework.LoggerHelper.Warning(
                    string.Format(
        ...
        public void Save()
        {
            if (IsEncrypted && !SecurePlayerPrefs.IsPassPhraseSet) BetaFramework.LoggerHelper.Warning("Please set the pass phrase that should be used. It is a security risk using the default value.");
