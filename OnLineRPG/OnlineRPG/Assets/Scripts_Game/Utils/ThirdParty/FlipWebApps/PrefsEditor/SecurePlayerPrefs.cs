...
namespace PrefsEditor
{
    ...
    public static class SecurePlayerPrefs
    {
        ...
        public static ItemType GetItemType(string encryptedString)
        {
            ...
            {
                //BetaFramework.LoggerHelper.Warning("Error Decrypting Prefs Item:" + e.Message);
        ...
        public static byte[] DecryptValue(string value, ItemType type)
        {
            ...
            {
                //BetaFramework.LoggerHelper.Warning("Error Decrypting Prefs String:" + e.Message);
                return null;
            }
        }
...
/*
        ...
        public static string Decrypt(string cipherText, string passPhrase)
        {
            ...
            {
                BetaFramework.LoggerHelper.Warning(e.ToString());
                return null;
            }
        }
