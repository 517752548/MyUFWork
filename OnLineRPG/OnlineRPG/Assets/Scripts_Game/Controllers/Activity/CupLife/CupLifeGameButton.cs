...
public class CupLifeGameButton : BaseEntranceBtn
{
    ...
    {
        rankText.text = "";
        AppEngine.SSystemManager.GetSystem<CupLifePlaySystem>().SetHomeButton(this);
        //EventDispatcher.AddEventListener(GlobalEvents.NewRoomEnter, CheckBegion);
        AppEngine.SSystemManager.GetSystem<CupLifePlaySystem>().TimeAction += ShowTime;
    }
