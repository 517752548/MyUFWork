...
public class FastRaceGameButton : BaseEntranceBtn
{
    ...
    {
        rankText.text = "";
        AppEngine.SSystemManager.GetSystem<FastRacePlaySystem>().SetHomeButton(this);
    ...
    {
        if (AppEngine.SSystemManager.GetSystem<FastRacePlaySystem>().ActivityImg())
        {
