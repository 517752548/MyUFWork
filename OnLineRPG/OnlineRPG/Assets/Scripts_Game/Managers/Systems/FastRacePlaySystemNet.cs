...
public class FastRacePlaySystemNet
{
    private FastRacePlaySystem frps;

    public FastRacePlaySystemNet(FastRacePlaySystem frps)
    {
        this.frps = frps;
    }
    ...
    {
        RequestConig requestConig = new RequestConig
        {
...
class FastRaceRoomRepPack
{
    public int code;
    public FastRaceRoomRepData data;
}

public class FastRaceRoomRepData
{
    public int roomId;
...
class RepFastRaceConfigPacket
{
    public int code;
    public RepFastRaceConfigPacketData data;
}

public class RepFastRaceConfigPacketData
{
    public int status;
...
class UploadScoreRep
{
    public int code;
    public UploadScoreRepData data;
}

public class MyRankIndex
{
    public int code;
    public MyRankInfo data;
}

public class RankList
{
    public int code;
    public RanListInfo data;
}

public class RanListInfo
{
    public int status;
    public List<RankListInfo> rankingList;
}
...
public class UploadScoreRepData
{
    public int status;
}
...
class RequestConig : BaseRequestParam
{
    public int acId;
    public string deviceId;
}
