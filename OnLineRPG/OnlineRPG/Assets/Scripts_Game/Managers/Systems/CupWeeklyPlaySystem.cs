...
public class CupWeeklyPlaySystem : ISystem
{
    public CupWeeklyPlaySystemNet net;

    private CupWeeklyGameButton _fastRaceGameButton;
    ...
    public override void InitSystem()
    {
        ...
        net = new CupWeeklyPlaySystemNet(this);
        EventUtil.EventDispatcher.AddEventListener(GlobalEvents.FRConfigInited, OnConfigLoad);
        net.GetConfig();
    }

    public void SetHomeButton(CupWeeklyGameButton _fastRaceGameButton)
    {
