...
public class FastRacePlaySystem : ISystem
{
    public FastRacePlaySystemNet net;

    private FastRaceGameButton _fastRaceGameButton;
    ...
    public override void InitSystem()
    {
        ...
        net = new FastRacePlaySystemNet(this);
        EventUtil.EventDispatcher.AddEventListener(GlobalEvents.FRConfigInited, OnConfigLoad);
        net.GetConfig();
    }

    public void SetHomeButton(FastRaceGameButton _fastRaceGameButton)
    {
