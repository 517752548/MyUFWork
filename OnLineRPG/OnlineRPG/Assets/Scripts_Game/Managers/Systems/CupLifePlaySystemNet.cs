...
public class CupLifePlaySystemNet
{
    private CupLifePlaySystem frps;

    public CupLifePlaySystemNet(CupLifePlaySystem frps)
    {
        this.frps = frps;
    }
    ...
    {
        CupLifeRequestConig requestConig = new CupLifeRequestConig
        {
...
class CupLifeRoomRepPack
{
    public int code;
    public CupLifeRoomRepData data;
}

public class CupLifeRoomRepData
{
    public int roomId;
...
class CupLifeRepConfigPacket
{
    public int code;
    public CupLifeRepConfigPacketData data;
}

public class CupLifeRepConfigPacketData
{
    public int status;
...
class CupLifeUploadScoreRep
{
    public int code;
    public CupLifeUploadScoreRepData data;
}

public class CupLifeMyRankIndex
{
    public int code;
    public CupWeeklyMyRankInfo data;
}

public class CupLifeRankList
{
    public int code;
    public CupWeeklyRanListInfo data;
}

public class CupLifeRanListInfo
{
    public int status;
    public List<CupLifeRankListInfo> rankingList;
}

public class CupLifeRankListInfo
{
...
public class CupLifeMyRankInfo
{
    public int status;
    public int rink;
    public int rewardId;
...
public class CupLifeUploadScoreRepData
{
    public int status;
}

class CupLifeRewardRep
{
    public int code;
}
...
class CupLifeRequestUploadScore
{
    public int mId;
    public int acId;
    public int roomId;
...
class CupLifeRequestConig : BaseRequestParam
{
    public int acId;
    public string deviceId;
}

class CupLifeRequestReward
{
    public int mId;
    public int acId;
    public int roomId;
