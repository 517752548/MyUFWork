...
namespace GoProfiler
{
	...
	//	bool showObjectInspector = false;
        ...
        void Init()
        {
            ...
            {
                BetaFramework.LoggerHelper.Log("Go-Profiler Init");
        ...
        void OnGUI()
        {
            ...
            //BetaFramework.LoggerHelper.Log("ONGUI"); 
            ...
            if (GUILayout.Button("Save Snapshot", EditorStyles.toolbarButton))
            {
                ...
                {
                    BetaFramework.LoggerHelper.Warning("No snapshot to save.  Try taking a snapshot first.");
                }
            }
        ...
        void IncomingSnapshot(PackedMemorySnapshot snapshot)
        {
            if (null==snapshot)
                return;
            BetaFramework.LoggerHelper.Log("GoProfilerWindow.IncomingSnapshot");
