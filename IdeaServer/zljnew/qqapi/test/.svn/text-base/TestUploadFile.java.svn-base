...
public class TestUploadFile {
	public static void main(String args[]) {
		...
		testAddPicWeibo(sdk, openid, openkey, pf,uuid);
	}
	 ...
	 * 
	 */
	public static void testAddPicWeibo(OpenApiV3 sdk, String openid, String openkey, String pf,String uuid) {
		// 指定OpenApi Cgi名字
		...
		try {
			...
			String resp = sdk.apiUploadFile(scriptName, params, pic, protocol,uuid);
