...
public interface DBService {
	 ...
	 * @throws DataAccessException
	 */
	public abstract Serializable save(BaseEntity entity) throws DataAccessException;
	 ...
	 * @deprecated
	 */
	public abstract void deleteById(Class<? extends BaseEntity> entityClass, Serializable id);
	 ...
	 * @deprecated
	 */
	public void softDeleteById(Class<? extends SoftDeleteEntity> entityClass, Serializable id) throws DataAccessException;
	 ...
	 * 
	 */
	public abstract int queryForUpdate(String queryName, String[] paramNames, Object[] values) throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public abstract List findByNamedQueryAndNamedParam(String queryName, String[] paramNames, Object[] values, int maxResult, int start)
			throws DataAccessException;
	 ...
	 * @throws DataAccessException
	 */
	public abstract void saveAll(List<BaseEntity> entityList) throws DataAccessException;
}