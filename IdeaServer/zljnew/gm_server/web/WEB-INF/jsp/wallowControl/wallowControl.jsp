...
<div id="man_zone">
<div class="topnav">
<a class="link" href="homePage.do?action=welcome"><%= lang.readGm(GMLangConstants.WEL_HOME_PAGE) %></a>>><%= lang.readGm(GMLangConstants.WALLOW_CONTROL) %>
</div>
<br/>
<c:choose>
...
<br/>
<div class="nofloat"/>
<form action="wallowControl.do?action=sendCmd" method="post">
<table cellspacing="0" class="welcome" style="width: 40%;margin-left: 1em;" cellpadding="1" >
	<tr>
		<td colspan="2" class="header" style="height: 30px;"><%=lang.readGm(GMLangConstants.WALLOW_CONTROL)%></td>
	</tr>
	<tr>
		<td class="label"><%=lang.readGm(GMLangConstants.WALLOW_OPTIONS)%></td>
		<td><select id="wallow" name="wallow" >
				<option  value="1"><%=lang.readGm(GMLangConstants.WALLOW_OPEN)%></option>
				<option  value="2"><%=lang.readGm(GMLangConstants.WALLOW_CLOSE)%></option>
			</select></td>
	</tr>
	<tr>
		...
		<table cellspacing="0" cellpadding="0" width="100%;" height="100%;">
			<c:forEach items="${serverList}" var="s"  varStatus="status">
    ...
    <tr>
		<td style="background-color: #9C9C9C" colspan="2" cellpadding="0"><%=lang.readGm(GMLangConstants.WALLOW_COLOR_DESC)%>
