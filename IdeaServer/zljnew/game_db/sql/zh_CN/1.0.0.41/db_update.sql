...
USE `tr_${server_id}`;
update t_db_version set version='1.0.0.41',updateTime=now();
...
if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_db_version' and column_name = 'tmpMergeFlag') then  
        alter table tr_${server_id}.t_db_version drop column tmpMergeFlag;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'formationPack') then  
        alter table tr_${server_id}.t_character_info drop column formationPack;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'defeatedEnemyArmy') then  
        alter table tr_${server_id}.t_character_info drop column defeatedEnemyArmy;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'armyTitleTalentData') then  
        alter table tr_${server_id}.t_character_info drop column armyTitleTalentData;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'raidPack') then  
        alter table tr_${server_id}.t_character_info drop column raidPack;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'godHeroPack') then  
        alter table tr_${server_id}.t_character_info drop column godHeroPack;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'mysteryShopPack') then  
        alter table tr_${server_id}.t_character_info drop column mysteryShopPack;
end if; 

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'drillGroundPack') then  
        alter table tr_${server_id}.t_character_info drop column drillGroundPack;
end if; 
