...
import com.imop.lj.robot.strategy.impl.GuaJiTestStrategy;
import com.imop.lj.robot.strategy.impl.HumanSkillTestStrategy;
import com.imop.lj.robot.strategy.impl.LifeSkillTestStrategy;
import com.imop.lj.robot.strategy.impl.MonthCardTestStrategy;
import com.imop.lj.robot.strategy.impl.PetHorseTestStrategy;
import com.imop.lj.robot.strategy.impl.PetTestStrategy;
import com.imop.lj.robot.strategy.impl.PlotDungeonTestStrategy;
import com.imop.lj.robot.strategy.impl.PubTaskTestStrategy;
...
//			robot.addRobotStrategy(new MonthCardTestStrategy(robot, 200));
//			robot.addRobotStrategy(new PubTaskTestStrategy(robot, 200));
...
//			robot.addRobotStrategy(new SiegeDemonTestStrategy(robot, 200));
			robot.addRobotStrategy(new HumanSkillTestStrategy(robot, 200));
//			robot.addRobotStrategy(new GuaJiTestStrategy(robot, 200));
//			robot.addRobotStrategy(new LifeSkillTestStrategy(robot, 200));
//			robot.addRobotStrategy(new LoadTestClickStrategy(robot, 5000, 2000, 10000));
			try {
