...
public abstract class QuestTemplateVO extends TemplateObject {
	...
	protected List<com.imop.lj.gameserver.task.template.SpecialDestination> specialDestination;
	...
	public int getVideoStoryId() {
		return this.videoStoryId;
	}

	public void setVideoStoryId(int videoStoryId) {
		if (videoStoryId < 0) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					32, "[动画剧情Id]videoStoryId的值不得小于0");
		}
		this.videoStoryId = videoStoryId;
	}
	...
	public List<com.imop.lj.gameserver.task.template.SpecialDestination> getSpecialDestination() {
		return this.specialDestination;
	}

	public void setSpecialDestination(List<com.imop.lj.gameserver.task.template.SpecialDestination> specialDestination) {
		if (specialDestination == null) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					34, "[特殊任务目标]specialDestination不可以为空");
		}	
	...
	public void setRewardIdOnCondition(List<Integer> rewardIdOnCondition) {
		if (rewardIdOnCondition == null) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					40, "[条件奖励ID]rewardIdOnCondition不可以为空");
		}	
	...
	public void setEnemyArmyIdList(List<Integer> enemyArmyIdList) {
		if (enemyArmyIdList == null) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					48, "[任务怪IdList]enemyArmyIdList不可以为空");
		}	
	...
	public void setTaskDropRewardId(int taskDropRewardId) {
		if (taskDropRewardId < 0) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					53, "[任务物品掉落奖励]taskDropRewardId的值不得小于0");
		}
