 ...
 */
public class CGPutonPetPropItem extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_PUTON_PET_PROP_ITEM;
	}
	
	@Override
	public String getTypeName() {
		return "CG_PUTON_PET_PROP_ITEM";
	}
	...
	@Override
	public void execute() {
		PetHandlerFactory.getHandler().handlePutonPetPropItem(this.getSession().getPlayer(), this);
	}
}