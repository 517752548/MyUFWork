...
@ExcelRowBinding
public abstract class PetHorsePerceptTypeTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorsePerceptTypeTemplateVO[itemId=" + itemId + ",itemNum=" + itemNum + ",currencyType=" + currencyType + ",currencyNum=" + currencyNum + ",]";
