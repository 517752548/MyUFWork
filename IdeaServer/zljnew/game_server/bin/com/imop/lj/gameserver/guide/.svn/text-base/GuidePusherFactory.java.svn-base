...
import com.imop.lj.gameserver.guide.pusher.AddFriendGuidePusher;
...
import com.imop.lj.gameserver.guide.pusher.GemGuidePusher;
...
import com.imop.lj.gameserver.guide.pusher.MindLevelupGuidePusher;
...
import com.imop.lj.gameserver.guide.pusher.RingTaskGuidePusher;
import com.imop.lj.gameserver.guide.pusher.SkillLevelupGuidePusher;
import com.imop.lj.gameserver.guide.pusher.SubSkillProGuidePusher;
...
public class GuidePusherFactory {
	...
	public static IGuidePusherFactory GemGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new GemGuidePusher();
		}
	};
	
	public static IGuidePusherFactory SubSkillProGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new SubSkillProGuidePusher();
		}
	};
	
	public static IGuidePusherFactory MindLevelupGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new MindLevelupGuidePusher();
		}
	};
	
	public static IGuidePusherFactory SkillLevelupGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new SkillLevelupGuidePusher();
		}
	};
	
	public static IGuidePusherFactory RingTaskGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new RingTaskGuidePusher();
		}
	};
	
	public static IGuidePusherFactory AddFriendGuidePusherFactory = new IGuidePusherFactory() {
		
		@Override
		public AbstractGuidePusher createGuidePusher() {
			return new AddFriendGuidePusher();
		}
	};
