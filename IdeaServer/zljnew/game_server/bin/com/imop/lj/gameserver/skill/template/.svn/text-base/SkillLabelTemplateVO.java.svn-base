...
@ExcelRowBinding
public abstract class SkillLabelTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "SkillLabelTemplateVO[nameLangId=" + nameLangId + ",name=" + name + ",effect=" + effect + ",effectShowType=" + effectShowType + ",maxLabelNum=" + maxLabelNum + ",]";
