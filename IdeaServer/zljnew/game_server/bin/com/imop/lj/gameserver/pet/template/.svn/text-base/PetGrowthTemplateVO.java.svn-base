...
public abstract class PetGrowthTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetGrowthTemplateVO[normalWeight=" + normalWeight + ",rubbishyWeight=" + rubbishyWeight + ",transformWeight=" + transformWeight + ",add=" + add + ",nameLangId=" + nameLangId + ",name=" + name + ",petScore=" + petScore + ",]";
