...
public class GameServerStatus extends ServerStatus {
	...
	public int getIphoneOnlineCount() {
		return iphoneOnlineCount;
	}

	public void setIphoneOnlineCount(int iphoneOnlineCount) {
		this.iphoneOnlineCount = iphoneOnlineCount;
	}
