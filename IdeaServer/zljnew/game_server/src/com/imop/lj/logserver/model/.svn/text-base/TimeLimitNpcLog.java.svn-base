...
public class TimeLimitNpcLog extends BaseLogMessage{
       private int curQuestId;
       private int curQuestStatus;
    
    public TimeLimitNpcLog() {    	
    }
    ...
    public TimeLimitNpcLog(
        ...
        super(MessageType.LOG_TIMELIMITNPC_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_TIMELIMITNPC_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_TIMELIMITNPC_RECORD";
    }
}