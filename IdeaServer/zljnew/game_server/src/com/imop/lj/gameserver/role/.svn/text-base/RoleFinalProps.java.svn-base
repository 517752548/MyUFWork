...
public class RoleFinalProps extends PropertyObject {
	...
	@Comment(content = "还童次数")
	@Type(Integer.class)
	public static final int PET_AFFINATION_NUM= ++_END;//734
	
	@Comment(content = "领悟技能成功率,扩大1000倍")
	@Type(Integer.class)
	public static final int PET_SENSE_RATE = ++_END;//735
	
	@Comment(content = "购买月卡时间")
	@Type(Long.class)
	public static final int BUY_MONTH_CARD_TIME = ++_END;//736
	
	@Comment(content = "非法请求战斗次数")
	@Type(Integer.class)
	public static final int INVALID_BATTLE_NUM= ++_END;//737
