...
@ExcelRowBinding
public abstract class RefreshActivityStateTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "RefreshActivityStateTemplateVO[refreshActivityTimeIds=" + refreshActivityTimeIds + ",]";
