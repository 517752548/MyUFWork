...
public class GCMallItemList extends GCMessage{
	...
	// 绑定状态，0绑定，1未绑定
	int _normalItemInfoList_commonItem_bind = readInteger();
	//end
	_normalItemInfoList_commonItem.setBind (_normalItemInfoList_commonItem_bind);
	...
	int normalItemInfoList_commonItem_bind = normalItemInfoList_commonItem.getBind ();

	// 绑定状态，0绑定，1未绑定
	writeInteger(normalItemInfoList_commonItem_bind);
