...
public enum PetBPropFromType {
	...
	/** 技能影响 */
	FROM_SKILL(3, RolePropertyManager.PROP_FROM_MARK_SKILL, PetBPropEffectorFactory.SKILL_EFFECTOR),
	/** title 影响 */
	FROM_TITLE(4,RolePropertyManager.PROP_FROM_MARK_TITLE, PetBPropEffectorFactory.TITLE_EFFECTOR),
	/** 翅膀 影响 */
	FROM_WING(5,RolePropertyManager.PROP_FROM_MARK_WING, PetBPropEffectorFactory.WING_EFFECTOR),
	/** 成长率相关 */
	FROM_GROWTH(6, RolePropertyManager.PROP_FROM_MARK_GROWTH, PetBPropEffectorFactory.GROWTH_EFFECTOR),
	/** 帮派修炼技能影响 */
	FROM_CORPS_CULTIVATE(7, RolePropertyManager.PROP_FROM_MARK_CORPS_CULTIVATE, PetBPropEffectorFactory.CORPS_CULTIVATE_EFFECTOR),
