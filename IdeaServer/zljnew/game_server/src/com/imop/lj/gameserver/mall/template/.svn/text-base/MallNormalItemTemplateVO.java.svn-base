...
public abstract class MallNormalItemTemplateVO extends TemplateObject {
	...
	protected List<com.imop.lj.common.model.template.ItemCostTemplate> exchangeItemList;
	...
	public List<com.imop.lj.common.model.template.ItemCostTemplate> getExchangeItemList() {
		return this.exchangeItemList;
	}

	public void setExchangeItemList(List<com.imop.lj.common.model.template.ItemCostTemplate> exchangeItemList) {
		if (exchangeItemList == null) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					12, "[兑换所需物品]exchangeItemList不可以为空");
		}	
	...
	public String toString() {
		return "MallNormalItemTemplateVO[notSale=" + notSale + ",sortId=" + sortId + ",normalItemList=" + normalItemList + ",catalogId=" + catalogId + ",sellWell=" + sellWell + ",priceList=" + priceList + ",exchangeItemList=" + exchangeItemList + ",marks=" + marks + ",subTag=" + subTag + ",]";
