...
import com.imop.lj.gameserver.charge.data.ChargePrizeInfo;
import com.imop.lj.gameserver.charge.template.ChargePrizeTemplate;
...
public class ChargePrizeService implements InitializeRequired{
	...
	/*****网页充值礼包列表*****/
	private List<ChargePrizeInfo> webChargePrizeList = new ArrayList<ChargePrizeInfo>();
