...
@ExcelRowBinding
public abstract class PetHorseTalentSkillPackTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorseTalentSkillPackTemplateVO[talentSkillList=" + talentSkillList + ",]";
