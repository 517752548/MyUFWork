...
public class HorseFunc extends AbstractFunc {

	public HorseFunc(Human human, FuncTypeEnum funcType) {
	...
	public boolean canShowEffect() {
		return Globals.getPetService().isNeedAddPointPetHorse(getOwner());
	}
