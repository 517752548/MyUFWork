...
import com.imop.lj.gameserver.guaji.msg.GuajiMsgMappingProvider;
...
import com.imop.lj.gameserver.ringtask.msg.RingtaskMsgMappingProvider;
...
public class ClientMessageRecognizer extends BaseMessageRecognizer implements
	...
	public void init() {
		...
		registerMsgMapping(new GuajiMsgMappingProvider());
		registerMsgMapping(new RingtaskMsgMappingProvider());
	}
