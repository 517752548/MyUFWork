 ...
 */
@ExcelRowBinding
public class PetPassiveNormalSkillTemplate extends PetPassiveNormalSkillTemplateVO {
	...
	public void check() throws TemplateConfigException {
		...
		//必须是普通技能，且为被动
		if (!skillTpl.isPassive() || skillTpl.getSkillType() != SkillType.PET_NORMAL) {
			throw new TemplateConfigException(this.sheetName, this.id, "技能Id在技能配置表不是宠物被动普通技能！");
		}
