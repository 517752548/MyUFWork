 ...
 */
@ExcelRowBinding
public class PetPassiveTalentSkillTemplate extends PetPassiveTalentSkillTemplateVO {
	...
	public void check() throws TemplateConfigException {
		...
		//必须是天赋技能，且为被动
		if (!skillTpl.isPassive() || skillTpl.getSkillType() != SkillType.PET_TALENT) {
			throw new TemplateConfigException(this.sheetName, this.id, "技能Id在技能配置表不是宠物被动天赋技能！");
		}
