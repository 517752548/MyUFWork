 ...
 */
@Entity
@Table(name = "t_task_forage")
@Comment(content="数据库实体类：护送粮草任务表")
public class ForageTaskEntity implements BaseEntity<String>, CharSubEntity {
	/** */
	...
	private int questId;
	/** 任务星数 */
	@Comment(content="任务星数")
	private int questStar;
	/** 战斗失败次数 */
	@Comment(content="战斗失败次数 ")
