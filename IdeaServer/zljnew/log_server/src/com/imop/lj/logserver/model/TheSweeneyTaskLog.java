...
public class TheSweeneyTaskLog extends BaseLogMessage{
       private int curQuestId;
       private int curQuestStatus;
    
    public TheSweeneyTaskLog() {    	
    }
    ...
    public TheSweeneyTaskLog(
        ...
        super(MessageType.LOG_THESWEENEYTASK_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_THESWEENEYTASK_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_THESWEENEYTASK_RECORD";
    }
}