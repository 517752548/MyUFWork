...
public class SiegeDemonTaskLog extends BaseLogMessage{
       private int curQuestId;
       private int curQuestStatus;
    
    public SiegeDemonTaskLog() {    	
    }
    ...
    public SiegeDemonTaskLog(
        ...
        super(MessageType.LOG_SIEGEDEMONTASK_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_SIEGEDEMONTASK_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_SIEGEDEMONTASK_RECORD";
    }
}