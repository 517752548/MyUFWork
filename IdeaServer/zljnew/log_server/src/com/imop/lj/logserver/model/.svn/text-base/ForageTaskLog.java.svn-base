...
public class ForageTaskLog extends BaseLogMessage{
    ...
    public ForageTaskLog(
        ...
        super(MessageType.LOG_FORAGETASK_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_FORAGETASK_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_FORAGETASK_RECORD";
    }
}