...
public class FieldObject {
	...
	private Set<String> subFieldTypeNames;
	...
	public Set<String> getSubFieldTypeNames() {
		return subFieldTypeNames;
	}

	public void setSubFieldTypeNames(Set<String> subFieldTypeNames) {
		this.subFieldTypeNames = subFieldTypeNames;
	}

	@Override
	public String toString() {
		return "FieldObject [smallName=" + smallName + ", bigName=" + bigName + ", type=" + type + ", clientType=" + clientType + ", comment="
				+ comment + ", list=" + list + ", subMsg=" + subMsg + ", subMsgType=" + subMsgType + ", bytes=" + bytes + ", ref=" + ref
				+ ", needCreateType=" + needCreateType + ", isNewType=" + isNewType + ", subFields=" + subFields + ", hasListField=" + hasListField
				+ "]";
	}
}
