...
USE `tr_${server_id}`;
update t_db_version set version='1.0.0.32',updateTime=now();
delete from t_item_info where deleted=1;

delete from t_qq_markettask_target;
INSERT INTO `t_qq_markettask_target` VALUES ('1', '1402901588442', '[{\"cid\":\"1101346127T320140609182330\",\"ctarget\":{\"step2\":{\"step\":2,\"target\":1,\"param1\":38},\"step3\":{\"step\":3,\"target\":1,\"param1\":50}}},{\"cid\":\"1101346127T320140610135012\",\"ctarget\":{\"step2\":{\"step\":2,\"target\":1,\"param1\":38},\"step3\":{\"step\":3,\"target\":2,\"param1\":7101}}}]');
