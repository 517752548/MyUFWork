USE `tr_${server_id}`;
update t_db_version set version='1.0.0.22',updateTime=now();

update t_dirtywords set dirtyWordsType=0;
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (507,'item_gen_log','物品产生','reason',572,'世界boss战排名奖励 ');
