...
public final class Amend {
	...
	/**
	 * 被修正的属性索引,参见{@link PetAProperty}{@link SoldierAProperty}
	 * {@link SoldierBProperty}等中的定义
	 */
	 ...
	 * @param properytIndex
	 */
	Amend(int key, int propertyType, int properytIndex) {
		this.key = key;
	...
	public String toString() {
		return "Amend [key=" + key + ", propertyType=" + propertyType + ", properytIndex=" + properytIndex + "]";
	}
