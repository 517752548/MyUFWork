...
public enum PetAPropFromType {
	...
	/** 技能影响 */
	FROM_SKILL(5, RolePropertyManager.PROP_FROM_MARK_SKILL, PetAPropEffectorFactory.SKILL_EFFECTOR),

	/** 骑宠影响 */
	FROM_HORSE(6,RolePropertyManager.PROP_FROM_MARK_HORSE,PetAPropEffectorFactory.HORSE_EFFECTOR),
