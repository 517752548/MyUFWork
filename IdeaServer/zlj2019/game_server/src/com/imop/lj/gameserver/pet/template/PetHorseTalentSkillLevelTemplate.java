 ...
 */
@ExcelRowBinding
public class PetHorseTalentSkillLevelTemplate extends PetHorseTalentSkillLevelTemplateVO {
	...
	public void check() throws TemplateConfigException {
		...
		if (null == skillTpl) {
			throw new TemplateConfigException(this.sheetName, this.id, "骑宠天赋技能Id不存在！" + this.talentSkillId);
		}
		if (skillTpl.getSkillType() != SkillType.PET_HORSE_TALENT) {
			throw new TemplateConfigException(this.sheetName, this.id, "该技能不是骑宠天赋技能！" + this.talentSkillId);
		}
		//技能等级是否在指定范围内
