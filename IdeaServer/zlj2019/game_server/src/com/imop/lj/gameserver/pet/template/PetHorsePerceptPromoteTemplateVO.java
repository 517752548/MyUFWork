...
@ExcelRowBinding
public abstract class PetHorsePerceptPromoteTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorsePerceptPromoteTemplateVO[promoteType=" + promoteType + ",perceptLevel=" + perceptLevel + ",singleExp=" + singleExp + ",singleSmallCritProp=" + singleSmallCritProp + ",singleBigCritProp=" + singleBigCritProp + ",batchSmallCritProp=" + batchSmallCritProp + ",batchBigCritProp=" + batchBigCritProp + ",]";
