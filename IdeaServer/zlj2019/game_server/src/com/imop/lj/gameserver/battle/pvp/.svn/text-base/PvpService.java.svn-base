...
public class PvpService extends PlayerBattleLogic<PvpBattleProcess> implements HeartBeatAble {
	...
	protected void onBattleEnd(PvpBattleProcess bp) {
		...
		//更改骑宠属性
		Human attackerHuman = Globals.getHumanCacheService().getHumanOnlineOrCache(attackerRoleId);
		Globals.getBattleService().onBattleEndPetHorsePropUpdate(attackerHuman, bp.getBattleResult() == BattleResult.ATTACKER);
		Human defenderHuman = Globals.getHumanCacheService().getHumanOnlineOrCache(defenderRoleId);
		Globals.getBattleService().onBattleEndPetHorsePropUpdate(defenderHuman, bp.getBattleResult() == BattleResult.ATTACKER);
	...
	public void forceEndBattle(PvpBattleProcess bp, String source) {
		...
		//更改骑宠属性
		Globals.getBattleService().onBattleEndPetHorsePropUpdate(atkPlayer.getHuman(), false);
		...
		//更改骑宠属性
		Globals.getBattleService().onBattleEndPetHorsePropUpdate(defPlayer.getHuman(), false);
