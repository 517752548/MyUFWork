...
@ExcelRowBinding
public class CorpsBossCountRankTemplate extends CorpsBossCountRankTemplateVO{
	...
	public void check() throws TemplateConfigException {
		...
		// 奖励类型检查
		if (rewardTpl.getRewardReasonType() != RewardReasonType.CORPS_BOSS_COUNT_RANK_REWARD) {
