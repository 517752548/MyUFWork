...
//	}
	...
	public RingTaskDao getRingTaskDao(){
		return daoHelper.ringTaskDao;
	}
	...
	public XianhuRankDao getXianhuRankDao() {
		return daoHelper.xianhuRankDao;
	}
	
	public XianhuDao getXianhuDao() {
		return daoHelper.xianhuDao;
	}
...
//		private final FinishedQuestDao finishedQuestDao;
		...
		/** 仙葫排行Dao */
		private final XianhuRankDao xianhuRankDao;
		/** 仙葫玩家数据Dao */
		private final XianhuDao xianhuDao;
...
//			battleReportDao = new BattleReportDao(battleReportDBConnection);
			...
			ringTaskDao = new RingTaskDao(dbService);
			...
			xianhuRankDao = new XianhuRankDao(dbService);
			xianhuDao = new XianhuDao(dbService);
		}
