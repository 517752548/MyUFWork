 ...
 */
public class CGBattleNextRoundPvp extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_BATTLE_NEXT_ROUND_PVP;
	}
	
	@Override
	public String getTypeName() {
		return "CG_BATTLE_NEXT_ROUND_PVP";
	}
	...
	@Override
	public void execute() {
		BattleHandlerFactory.getHandler().handleBattleNextRoundPvp(this.getSession().getPlayer(), this);
	}
}