...
//		GIFT(30, FuncFactory.GiftFuncFactory),
		...
		/** 仙葫 */
		XIANHU(79, FuncFactory.XianhuFuncFactory),
		/** 挂机 */
		GUA_JI(80, FuncFactory.GuaJiFuncFactory),
		/** 生活技能 */
		LIFE_SKILL(81, FuncFactory.LifeSkillFuncFactory),
		/**生活技能书商店*/
		LIFE_SKILL_STORE(82, FuncFactory.LifeSkillStoreFactory),
		/**月卡*/
		MONTH_CARD(83, FuncFactory.MonthCardFactory),
		/**跑环*/
		RING(84, FuncFactory.RingFactory),
