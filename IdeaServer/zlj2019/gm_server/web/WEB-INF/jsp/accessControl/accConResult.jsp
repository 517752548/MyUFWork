...
<table cellspacing="" class="welcome" style="width: 40%;margin-left: 1em;" cellpadding="20" >
	<tr>
		<td  class="header"><%=lang.readGm(GMLangConstants.ACCESS_CONTROL)%><%=lang.readGm(GMLangConstants.RESULT)%></td>
	</tr>
	<tr>
		<td><textarea  cols="50" rows="20" name="content">${result}</textarea></td>
	</tr>
	<tr><td><input type="button" value="<%=lang.readGm(GMLangConstants.RETURN) %>" onclick="window.location='accessControl.do?action=init'"/></td></tr>
</table>
