...
public class TreasureMapLog extends BaseLogMessage{
       private int curQuestId;
       private int curQuestStatus;
    
    public TreasureMapLog() {    	
    }
    ...
    public TreasureMapLog(
        ...
        super(MessageType.LOG_TREASUREMAP_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_TREASUREMAP_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_TREASUREMAP_RECORD";
    }
}