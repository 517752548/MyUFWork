...
import com.renren.games.api.runable.QQFinishMarketTaskRunable;
import com.renren.games.api.util.CommonUtil;

public class QQFinishMarketTaskServlet extends HttpServlet {

	private static final long serialVersionUID = -3001297242364140360L;

	private String url = "/api/qq/qqFinishMarketTask";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			QQFinishMarketTaskRunable runable = new QQFinishMarketTaskRunable(requestParams, uuid);
