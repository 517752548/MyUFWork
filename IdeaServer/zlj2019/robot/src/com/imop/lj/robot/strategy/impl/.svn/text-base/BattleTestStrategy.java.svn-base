...
//		this.sendMessage(nextMsg);
		...
		//设置玩家自动战斗技能
		CGBattleUpdateAutoAction updateAutoMsg = new CGBattleUpdateAutoAction(1,14001);
		this.sendMessage(updateAutoMsg);
		//设置宠物自动战斗技能
		CGBattleUpdateAutoAction updatePetAutoMsg = new CGBattleUpdateAutoAction(2,3);
...
//			}
			...
			this.sendMessage(nextMsg);
			CGBattleReadReportEnd endMsg = new CGBattleReadReportEnd();
