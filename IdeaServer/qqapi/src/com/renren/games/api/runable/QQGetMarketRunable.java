 ...
 * 
 */
public class QQGetMarketRunable extends ApiCallable {
	...
	public QQGetMarketRunable(Map<String, String> params, String uuid) {
		this.params = params;
		this.uuid = uuid;
	}
	...
	public String execute() {
		...
		try {
			...
			result = Globals.getQqMarketService().getMarketAward(appid, openid, uuid);
		} catch (Exception e) {
