...
@ExcelRowBinding
public abstract class IpadChargeTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "IpadChargeTemplateVO[productId=" + productId + ",appid=" + appid + ",nameLangId=" + nameLangId + ",name=" + name + ",descLangId=" + descLangId + ",desc=" + desc + ",icon=" + icon + ",costRMB=" + costRMB + ",coins=" + coins + ",areaId=" + areaId + ",appType=" + appType + ",amount=" + amount + ",]";
