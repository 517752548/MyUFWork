...
public interface RewardDef {
	...
	public final static String REWARD_BIND ="15";
	...
	public final static String CALC_KEY_STAR = "star";
	public final static String CALC_KEY_LAYER = "layer";
	public final static String CALC_KEY_HUMAN_NUM = "humannum";
	public final static String CALC_KEY_EXAM_ANSWER = "answer";
	public final static String CALC_KEY_RING_NUM = "ringnum";
	public final static String CALC_KEY_VIP = "vip";
	...
	public enum RewardCalculateType implements IndexedEnum {
		...
		/** 酒馆奖励*/
		PUB(3, CalculateRewardFactory.PubCalculator),
		/** 绿野仙踪奖励*/
		WIZARDRAID_NORMAL(4, CalculateRewardFactory.WizardRaidNoramlRewardCalculator),
		/** 封印小妖奖励*/
		SEAL_DEMON(5, CalculateRewardFactory.SealDemonCalculator),
		/** 通天塔奖励*/
		TOWER(6, CalculateRewardFactory.TowerCalculator),
		/** 跑环奖励*/
		RING(7, CalculateRewardFactory.RingCalculator),
		;
...
//		REWARD_CORPS_EXP(5, new CorpsExpSubReward(null)),
	...
	public enum RewardReasonType implements IndexedEnum {
		...
		/** 仙葫排名奖励 */
		XIANHU_RANK_REWARD(154, null, MoneyLogReason.XIANHU_RANK_REWARD, ItemGenLogReason.XIANHU_RANK_REWARD, ItemLogReason.XIANHU_RANK_REWARD, null, null),
		/** 仙葫祝福奖励 */
		XIANHU_ZHUFU_REWARD(155, null, MoneyLogReason.XIANHU_ZHUFU_REWARD, ItemGenLogReason.XIANHU_ZHUFU_REWARD, ItemLogReason.XIANHU_ZHUFU_REWARD, null, null),
		/** 仙葫祈福奖励 */
		XIANHU_QIFU_REWARD(156, null, MoneyLogReason.XIANHU_QIFU_REWARD, ItemGenLogReason.XIANHU_QIFU_REWARD, ItemLogReason.XIANHU_QIFU_REWARD, null, null),
		/** 仙葫祈福额外奖励 */
		XIANHU_EXTRA_REWARD(157, null, MoneyLogReason.XIANHU_EXTRA_REWARD, ItemGenLogReason.XIANHU_EXTRA_REWARD, ItemLogReason.XIANHU_EXTRA_REWARD, null, null),
		
		/** 跑环任务奖励 */
		RING_TASK_REWARD(158, PetExpLogReason.RING_TASK_REWARD, MoneyLogReason.RING_TASK_REWARD, ItemGenLogReason.RING_TASK_REWARD, ItemLogReason.RING_TASK_REWARD, null, null),
		;
