...
//		amendList.add(new MissionWorldLevelRewardAmend());
	 ...
	 * @return
	 */
	public Reward createRewardWithAmend(long createRewardCharId, int rewardId, String logContent, Map<RewardAddedFromType, IRewardAmend> addAmendMap, Map<String, Object> params) {
		return this.createReward(createRewardCharId, rewardId, logContent, params, true, RewardAmendType.HUMAN, addAmendMap);
	}
	 ...
	 * @return
	 */
	public Reward createRewardWithAmend(long createRewardCharId, int rewardId, String logContent, IRewardAmend addAmend, Map<String, Object> params) {
		...
		return this.createRewardWithAmend(createRewardCharId, rewardId, logContent, addAmendMap, params);
	}
	...
	protected Reward createReward(long createRewardCharId, int rewardId, String logContent, Map<String, Object> params, boolean saveLog, 
		...
		//绑定状态
		if (reward.getBindType() != null) {
			rewardObject.put(RewardDef.REWARD_BIND, reward.getBindType().getIndex());
		}
	...
	/**
	 * 给奖励，道具的绑定状态由参数isBind决定
	 * @param human
	 * @param reward
	 * @param isBind 道具奖励是否绑定，true绑定，false非绑定，不考虑道具模板本身，仅由该参数决定
	 * @param needNotify
	 * @return
	 */
	public boolean giveReward(Human human, Reward reward, boolean isBind, boolean needNotify) {
		if(human == null){
			return false;
		}
		...
		//设置绑定状态
		reward.setBindType(isBind ? BindType.BIND : BindType.NOT_BIND);
		return reward.giveReward(human, needNotify);
	}
