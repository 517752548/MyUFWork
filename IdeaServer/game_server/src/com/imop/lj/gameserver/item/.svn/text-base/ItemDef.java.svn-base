...
public interface ItemDef {
	...
	public static enum ItemType implements IndexedEnum {
		...
		/** 装备打造材料 */
		CRAFT_EQUIP_ITEM(12, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 强壮凡品资质丹 */
		PET_STRENGTH_NORMAL_ITEM(13, Catalogue.CRAFT_EQUIP_ITEM),
		/** 强壮中品资质丹 */
		PET_STRENGTH_MIDDLE_ITEM(14, Catalogue.CRAFT_EQUIP_ITEM),
		/** 强壮良品资质丹 */
		PET_STRENGTH_GOOD_ITEM(15, Catalogue.CRAFT_EQUIP_ITEM),
		/** 强壮精品资质丹 */
		PET_STRENGTH_BEST_ITEM(16, Catalogue.CRAFT_EQUIP_ITEM),
		/** 强壮灵品资质丹 */
		PET_STRENGTH_SPIRIT_ITEM(17, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 敏捷凡品资质丹 */
		PET_AGILITY_NORMAL_ITEM(18, Catalogue.CRAFT_EQUIP_ITEM),
		/** 敏捷中品资质丹 */
		PET_AGILITY_MIDDLE_ITEM(19, Catalogue.CRAFT_EQUIP_ITEM),
		/** 敏捷良品资质丹 */
		PET_AGILITY_GOOD_ITEM(20, Catalogue.CRAFT_EQUIP_ITEM),
		/** 敏捷精品资质丹 */
		PET_AGILITY_BEST_ITEM(21, Catalogue.CRAFT_EQUIP_ITEM),
		/** 敏捷灵品资质丹 */
		PET_AGILITY_SPIRIT_ITEM(22, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 智力凡品资质丹 */
		PET_INTELLECT_NORMAL_ITEM(23, Catalogue.CRAFT_EQUIP_ITEM),
		/** 智力中品资质丹 */
		PET_INTELLECT_MIDDLE_ITEM(24, Catalogue.CRAFT_EQUIP_ITEM),
		/** 智力良品资质丹 */
		PET_INTELLECT_GOOD_ITEM(25, Catalogue.CRAFT_EQUIP_ITEM),
		/** 智力精品资质丹 */
		PET_INTELLECT_BEST_ITEM(26, Catalogue.CRAFT_EQUIP_ITEM),
		/** 智力灵品资质丹 */
		PET_INTELLECT_SPIRIT_ITEM(27, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 信仰凡品资质丹 */
		PET_FAITH_NORMAL_ITEM(28, Catalogue.CRAFT_EQUIP_ITEM),
		/** 信仰中品资质丹 */
		PET_FAITH_MIDDLE_ITEM(29, Catalogue.CRAFT_EQUIP_ITEM),
		/** 信仰良品资质丹 */
		PET_FAITH_GOOD_ITEM(30, Catalogue.CRAFT_EQUIP_ITEM),
		/** 信仰精品资质丹 */
		PET_FAITH_BEST_ITEM(31, Catalogue.CRAFT_EQUIP_ITEM),
		/** 信仰灵品资质丹 */
		PET_FAITH_SPIRIT_ITEM(32, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 耐力凡品资质丹 */
		PET_STAMINA_NORMAL_ITEM(33, Catalogue.CRAFT_EQUIP_ITEM),
		/** 耐力中品资质丹 */
		PET_STAMINA_MIDDLE_ITEM(34, Catalogue.CRAFT_EQUIP_ITEM),
		/** 耐力良品资质丹 */
		PET_STAMINA_GOOD_ITEM(35, Catalogue.CRAFT_EQUIP_ITEM),
		/** 耐力精品资质丹 */
		PET_STAMINA_BEST_ITEM(36, Catalogue.CRAFT_EQUIP_ITEM),
		/** 耐力灵品资质丹 */
		PET_STAMINA_SPIRIT_ITEM(37, Catalogue.CRAFT_EQUIP_ITEM),
		
		/** 生活技能书 */
		LIFE_SKILL_BOOK(38, Catalogue.LIFE_SKILL_BOOK),
		/** 骑宠技能书 */
		PET_HORSE_SKILL_BOOK(39, Catalogue.PET_HORSE_SKILL_BOOK),
		
		/** 灵犀仙葫，礼包类消耗品，单独定义类型，需要特殊处理 */
		XIANHU_LINGXI(50, Catalogue.CONSUMABLE),
	...
	public static enum Rarity implements IndexedEnum {
		...
		private Rarity(int index, String color, int addPropNum) {
			this.index = index;
			this.color = color;
			this.addPropNum = addPropNum;
		}
		...
		public int getAddPropNum() {
			return this.addPropNum;
		}
...
//	}
	 ...
	 *
	 */
	public static enum Recipe implements IndexedEnum {
		/** 普通 */
		ONE(1),
		/** 稀有 */
		TWO(2),
		...
		private static final List<Recipe> values = IndexedEnumUtil.toIndexes(Recipe.values());

		public static Recipe valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	}
	
	public static enum BindType implements IndexedEnum {
		/** 绑定或已绑定 */
		BIND(0),
		/** 未绑定 */
		NOT_BIND(1),
		...
		private static final List<BindType> values = IndexedEnumUtil.toIndexes(BindType.values());

		public static BindType valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	}
}
