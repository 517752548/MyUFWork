 ...
 */
public class CGBattleNextRoundTeam extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_BATTLE_NEXT_ROUND_TEAM;
	}
	
	@Override
	public String getTypeName() {
		return "CG_BATTLE_NEXT_ROUND_TEAM";
	}
	...
	@Override
	public void execute() {
		BattleHandlerFactory.getHandler().handleBattleNextRoundTeam(this.getSession().getPlayer(), this);
	}
}