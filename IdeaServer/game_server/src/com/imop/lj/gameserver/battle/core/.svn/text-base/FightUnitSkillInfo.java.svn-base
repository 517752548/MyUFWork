...
public class FightUnitSkillInfo implements Cloneable {
	...
	private int skillLayer = PetDef.DEFAULT_SKILL_LAYER;
	private int weight;
	private int cdRound;
	...
	public FightUnitSkillInfo(int skillId, int skillLevel, int skillLayer) {
		this.skillId = skillId;
		this.skillLevel = skillLevel;
		this.skillLayer = skillLayer;
	}
	
	public FightUnitSkillInfo(int skillId, int skillLevel, int skillLayer, int weight, int cdRound) {
		this.skillId = skillId;
		this.skillLevel = skillLevel;
		this.skillLayer = skillLayer;
		this.weight = weight;
	...
	public FightUnitSkillInfo clone() {
		FightUnitSkillInfo info = new FightUnitSkillInfo(skillId, skillLevel, skillLayer , weight, cdRound);
