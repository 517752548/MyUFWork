...
@ExcelRowBinding
public abstract class PetHorsePassiveNormalSkillTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorsePassiveNormalSkillTemplateVO[name=" + name + ",propList=" + propList + ",]";
