 ...
 */
public class CGPetSkillPutonShortcut extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_PET_SKILL_PUTON_SHORTCUT;
	}
	
	@Override
	public String getTypeName() {
		return "CG_PET_SKILL_PUTON_SHORTCUT";
	}
	...
	@Override
	public void execute() {
		PetHandlerFactory.getHandler().handlePetSkillPutonShortcut(this.getSession().getPlayer(), this);
	}
}