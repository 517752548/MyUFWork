 ...
 */
public class CGPetFriendChangePosition extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_PET_FRIEND_CHANGE_POSITION;
	}
	
	@Override
	public String getTypeName() {
		return "CG_PET_FRIEND_CHANGE_POSITION";
	}
	...
	@Override
	public void execute() {
		PetHandlerFactory.getHandler().handlePetFriendChangePosition(this.getSession().getPlayer(), this);
	}
}