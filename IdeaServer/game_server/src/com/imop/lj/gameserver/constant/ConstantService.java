    ...
    protected ConstantInfo buildConstantInfo(ConstantEnum constantEnum) {
        ...
        switch (constantEnum) {
            ...
            case PET_TALENT_ITEMID:
                ...
                break;
            case BEST_PET_TALENT_ITEMID:
            	value = Globals.getGameConstants().getBestPetTalentSkillResetItemId() + "";
            	break;
            case PET_HORSE_TALENT_ITEMID:
            	value = Globals.getGameConstants().getPetHorseTalentSkillResetItemId() + "";
            	break;
            case BEST_PET_HORSE_TALENT_ITEMID:
            	value = Globals.getGameConstants().getBestPetHorseTalentSkillResetItemId() + "";
            	break;
            ...
            case SIEGE_DEMON_HARD_MIN_LEVEL :
            	...
            	value = funcOpenTpl != null ? funcOpenTpl.getLimitLevel()+"": "0" ;
            	break;
            case SKILL_PROFICIENCY_ITEM_ID:
            	value = Globals.getGameConstants().getAddProficiencyItemId() + "";
            	break;
            case ADD_SKILL_PROFICIENCY_NUM:
            	value = Globals.getGameConstants().getAddProficiencyNum() + "";
            	break;
            case ADD_PET_SKILL_BAR_NUM:
            	value = Globals.getGameConstants().getSkillBarNumItemId() + "";
            	break;
            case PET_RESET_TALENT_SKILL_COST_LIFE_NUM:
            	value = Globals.getGameConstants().getPetTalentSkillResetLifeNum() + "";
            	break;
            case PET_HORSE_RESET_TALENT_SKILL_COST_LIFE_NUM:
            	value = Globals.getGameConstants().getPetHorseTalentSkillResetLifeNum() + "";
            	break;
            case GEM_UP_PROB1:
            	value = Globals.getGameConstants().getGemUpNormalProb() + "";
            	break;
            case GEM_UP_PROB2:
            	value = Globals.getGameConstants().getGemUpGoodProb() + "";
            	break;
            case GEM_DOWN_PROB1:
            	value = Globals.getGameConstants().getGemDownNormalProb() + "";
            	break;
            case GEM_DOWN_PROB2:
            	value = Globals.getGameConstants().getGemDownGoodProb() + "";
            	break;
            case GEM_LEVEL_COEF:
            	value = Globals.getGameConstants().getGemLevelCoef() + "";
            	break;
            case GUA_JI_PROB:
            	value = Globals.getGameConstants().getGuaJiProb() + "";
            	break;
            case GUA_JI_MAX_NUM:
            	value = Globals.getGameConstants().getGuaJiPointMaxNum() + "";
            	break;
            case LIFE_SKILL_CD:
            	value = Globals.getGameConstants().getLifeSkillCostCD() + "";
            	break;
            case LIFE_SKILL_MP:
            	value = Globals.getGameConstants().getLifeSkillCostMP() + "";
            	break;
            case LIFE_SKILL_OFFSET:
            	value = Globals.getGameConstants().getLifePointInAreaOffset() + "";
            	break;
            case PET_PERCEPT_TIMES:
            	value = Globals.getGameConstants().getPetPerceptTimesByBatch() + "";
            	break;
            case XIANHU_QIFU_COST:
            	value = Globals.getGameConstants().getXianhuQifuCostBond() + "";
            	break;
            case XIANHU_ZHUFU_COST:
            	value = Globals.getGameConstants().getXianhuZhufuCostCoef() + "";
            	break;
            case PET_HORSE_LOY_MAX:
            	value = Globals.getGameConstants().getPetHorseMaxLoy() + "";
            	break;
            case PET_HORSE_CLO_MAX:
            	value = Globals.getGameConstants().getPetHorseMaxClo() + "";
            	break;
            default:
                break;
        }
