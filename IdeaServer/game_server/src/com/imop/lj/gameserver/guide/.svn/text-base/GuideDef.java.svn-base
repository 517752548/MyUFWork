...
public interface GuideDef {
	...
	public enum GuideType implements IndexedEnum {
		...
		/** 打造 */
		CRAFT(16, GuidePusherFactory.CraftGuidePusherFactory, FuncTypeEnum.CRAFT, true),
		/** 宠物洗天赋技能 */
		PET_TALENT_REFRESH(17, GuidePusherFactory.PetTalentGuidePusherFactory, null, false),
		/** 宝石镶嵌，含打孔和镶嵌 */
		GEM_EQUIP(18, GuidePusherFactory.GemGuidePusherFactory, FuncTypeEnum.GEM_EQUIP, true),
		
		/** 技能熟练度升级 */
		SUB_SKILL_PROFICIENCY(19, GuidePusherFactory.SubSkillProGuidePusherFactory, null, false),
		/** 心法升级 */
		MIND_LEVELUP(20, GuidePusherFactory.MindLevelupGuidePusherFactory, null, false),
		/** 技能升级 */
		SKILL_LEVELUP(21, GuidePusherFactory.SkillLevelupGuidePusherFactory, null, false),
		/** 跑环 */
		RING_TASK(22, GuidePusherFactory.RingTaskGuidePusherFactory, FuncTypeEnum.RING, true),
		/** 添加好友 */
		ADD_FRIEND(23, GuidePusherFactory.AddFriendGuidePusherFactory, null, false),
