...
public class PetBattleSnap {
	...
	public static final String SOUL_LINK_PET_HORSE_ID = "slId";
	...
	public static PetBattleSnap fromJson(String json) {
		...
		snap.setSoulLinkPetHorseId(JsonUtils.getLong(obj, SOUL_LINK_PET_HORSE_ID));
		return snap;
	}
	...
	public String toJson(boolean isShow) {
		...
		obj.put(SOUL_LINK_PET_HORSE_ID, getSoulLinkPetHorseId());
	...
	public void onUpdate(Pet pet) {
		...
		this.soulLinkPetHorseId = Globals.getPetService().getSoulPetHorseByPetId(pet.getCharId(), pet.getUUID());
	}
