...
public class MainBagGetItemEvent extends Event<Human>{
	...
	private final static EventType eventType = EventType.MainBagGetItem;

	public MainBagGetItemEvent(Human human, ItemTemplate tmpl, int count) {
