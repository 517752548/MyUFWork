...
import com.imop.lj.logserver.model.RingTaskLog;
...
public class LogService {
	 ...
	 * @param curQuestStatus 当前任务状态
	 */
	public void sendRingTaskLog(Human human,
				LogReasons.RingTaskLogReason reason,				String param			,int curQuestId
			,int curQuestStatus
		) {
		this.sendLogMessage(new RingTaskLog(
