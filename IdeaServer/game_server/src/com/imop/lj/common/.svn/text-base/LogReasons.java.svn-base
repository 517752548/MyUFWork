...
public interface LogReasons {
    ...
    public enum ItemGenLogReason implements ILogReason {
        ...
        @ReasonDesc("合成道具给")
        ITEM_COMPOSE_GIVE(14, "合成道具给|消耗道具Id={0}|消耗道具数量={1}"),
        ...
        @ReasonDesc("装备打造给装备")
        CRAFT_EQUIP_GIVE(650, "装备打造给装备|打造模板Id={0}|阶数={1}"),

        @ReasonDesc("摘除宝石增加")
        GEM_TAKE_OFF(660, "摘除宝石增加|宝石模板ID={0}|装备唯一id={1}|装备模板Id={2}|装备孔数={3}"),
        ...
        @ReasonDesc("合成宝石")
        SYNTHESIS_GEM(665, "合成宝石|非绑定数量={0}|绑定数量={1}"),
        
        @ReasonDesc("生活技能产出")
        LIFE_SKILL_GEN(666, "生活技能产出 | 道具Id = {0}"),
        ...
        @ReasonDesc("仙葫排名奖励")
		XIANHU_RANK_REWARD(741, "仙葫排名奖励"),
		@ReasonDesc("仙葫祝福奖励")
		XIANHU_ZHUFU_REWARD(742, "仙葫祝福奖励"),
		@ReasonDesc("仙葫祈福奖励")
		XIANHU_QIFU_REWARD(743, "仙葫祈福奖励"),
		@ReasonDesc("仙葫祈福额外奖励")
		XIANHU_EXTRA_REWARD(744, "仙葫祈福额外奖励"),
		@ReasonDesc("跑环任务奖励")
        RING_TASK_REWARD(745, "跑环任务奖励"),
    ...
    public enum PetLogReason implements ILogReason {
        ...
        @ReasonDesc("宠物学习普通技能")
        PET_STUDY_NORMAL_SKILL(105, "宠物学习普通技能|是否已有技能={0}|学习技能Id={1}|技能等级old={2}|技能等级new={3}"),
        ...
        @ReasonDesc("扩充宠物技能栏数量")
        PET_ADD_SKILLBAR_NUM(127, "扩充宠物技能栏数量"),
        @ReasonDesc("宠物洗炼")
        PET_AFFINATION(128, "宠物洗炼"),
        @ReasonDesc("设置宠物资质丹")
        PET_PUTON_PROP_ITEM(129, "设置宠物资质丹|资质index={0}|资质丹索引={1}"),
        ...
        @ReasonDesc("骑宠学习普通技能")
        PET_HORSE_STUDY_NORMAL_SKILL(142, "骑宠学习普通技能|是否已有技能={0}|学习技能Id={1}|技能等级old={2}|技能等级new={3}"),
        ...
        @ReasonDesc("扩充骑宠技能栏数量")
        PET_HORSE_ADD_SKILLBAR_NUM(155, "扩充宠物技能栏数量"),
        @ReasonDesc("骑宠洗炼")
        PET_HORSE_AFFINATION(156, "宠物洗炼"),
        @ReasonDesc("设置骑宠资质丹")
        PET_HORSE_PUTON_PROP_ITEM(157, "设置宠物资质丹|资质index={0}|资质丹索引={1}"),
        @ReasonDesc("骑宠变异")
        PET_HORSE_VARIATION(158, "骑宠变异|是否变异={1}"),
    ...
    public enum ItemLogReason implements ILogReason {
        ...
        @ReasonDesc("技能熟练度扣除")
        SKILL_PROFICIENCY_COST(48, "技能熟练度消耗"),
        @ReasonDesc("扩充宠物技能栏道具扣除")
        SKILL_BAR_COST(49, "扩充宠物技能栏道具消耗"),
        @ReasonDesc("骑宠属性丹扣除")
        PET_HORSE_PROP_COST(50, "骑宠属性丹消耗"),
        @ReasonDesc("经验丹扣除")
        EXP_COST(51, "经验丹扣除"),
        ...
        @ReasonDesc("合成道具消耗")
        ITEM_COMPOSE_COST(351, "合成道具消耗|合成道具Id={0}|合成道具数量={1}"),
        ...
        @ReasonDesc("打造装备扣除材料")
        COST_ITEM_FOR_CRAFT_EQUIP(11001, "打造花费模板ID={0}"),
        ...
        @ReasonDesc("骑宠学习普通技能扣技能书")
        PET_HROSE_NORMAL_SKILL_STUDY_COST(12004, "骑宠学习普通技能扣技能书|宠物Id={0}|技能Id={1}"),
        ...
        @ReasonDesc("仙葫排名奖励")
		XIANHU_RANK_REWARD(13631, "仙葫排名奖励"),
		@ReasonDesc("仙葫祝福奖励")
		XIANHU_ZHUFU_REWARD(13632, "仙葫祝福奖励"),
		@ReasonDesc("仙葫祈福奖励")
		XIANHU_QIFU_REWARD(13633, "仙葫祈福奖励"),
		@ReasonDesc("仙葫祈福额外奖励")
		XIANHU_EXTRA_REWARD(13634, "仙葫祈福额外奖励"),
		@ReasonDesc("跑环任务奖励")
        RING_TASK_REWARD(13635, "跑环任务奖励"),
        ...
        @ReasonDesc("升级人物心法技能扣除技能书")
        SUB_SKILL_UPGRADE_COST(18002, "技能书ID={0}"),
        @ReasonDesc("兑换商城物品扣除道具")
        EXCHANGE_MALL_ITEM_COST(18003, "道具ID={0}"),
        @ReasonDesc("升级宠物扣除宠物资质丹")
        UPGRADE_PET_LEVEL_PROP_ITEM_COST(18004, "道具ID={0}"),
        @ReasonDesc("扩充宠物技能栏扣除道具")
        ADD_PET_SKILLBAR_ITEM_COST(18005, "道具ID={0}"),
        @ReasonDesc("升级生活技能扣除技能书")
        LIFE_SKILL_UPGRADE_COST(18006, "技能书ID={0}"),
        @ReasonDesc("扩充骑宠技能栏扣除道具")
        ADD_PET_HORSE_SKILLBAR_ITEM_COST(18007, "道具ID={0}"),
        ...
        @ReasonDesc("装备打孔消耗道具")
        EQUIP_HOLE_CREATE(2100, "装备打孔消耗道具|孔数={0}"),
        @ReasonDesc("装备洗孔消耗道具")
        EQUIP_HOLE_REFRESH(2101, "装备洗孔消耗道具|孔数={0}"),
        @ReasonDesc("镶嵌消耗宝石")
        EQUIP_GEM_UP(2102, "镶嵌消耗宝石|孔数={0}|装备唯一id={1}"),
        @ReasonDesc("镶嵌消耗符文")
        EQUIP_GEM_UP_EXTRA(2103, "镶嵌消耗符文|孔数={0}|装备唯一id={1}"),
        @ReasonDesc("摘除消耗符文")
        EQUIP_GEM_DOWN_EXTRA(2104, "摘除消耗符文|孔数={0}|装备唯一id={1}"),
    ...
    public enum MoneyLogReason implements ILogReason {
        ...
        COST_GOLD_BY_CRAFT_EQUIP(11001, "打造装备消耗游戏币|打造花费模板ID={0}"),
        ...
        @ReasonDesc("仙葫排名奖励")
		XIANHU_RANK_REWARD(11097, "仙葫排名奖励"),
		@ReasonDesc("仙葫祝福奖励")
		XIANHU_ZHUFU_REWARD(11098, "仙葫祝福奖励"),
		@ReasonDesc("仙葫祈福奖励")
		XIANHU_QIFU_REWARD(11099, "仙葫祈福奖励"),
		@ReasonDesc("仙葫祈福额外奖励")
		XIANHU_EXTRA_REWARD(11100, "仙葫祈福额外奖励"),
		@ReasonDesc("跑环任务奖励")
        RING_TASK_REWARD(11101, "跑环任务奖励"),
        ...
        @ReasonDesc("装备打孔")
        EQUIP_HOLE_CREATE(18100, "装备打孔|装备模板Id={0}|孔数={1}|装备唯一id={2}"),
        @ReasonDesc("装备洗孔")
        EQUIP_HOLE_REFRESH(18101, "装备洗孔|装备模板Id={0}|孔数={1}|装备唯一id={2}"),
        @ReasonDesc("镶嵌宝石扣除")
        EQUIP_GEM_UP(18102, "镶嵌宝石扣除|装备模板Id={0}|孔数={1}|装备唯一id={2}|宝石模板Id={3}"),
        @ReasonDesc("摘除宝石扣除")
        EQUIP_GEM_DOWN(18103, "摘除宝石扣除|装备模板Id={0}|孔数={1}|装备唯一id={2}|宝石模板Id={3}"),
        
        @ReasonDesc("开启祝福仙葫扣除")
        XIANHU_ZHUFU_COST(18201, "开启祝福仙葫扣除|次数={0}"),
        @ReasonDesc("开启祈福仙葫扣除")
        XIANHU_QIFU_COST(18202, "开启祈福仙葫扣除|次数={0}"),
        
        @ReasonDesc("开始挂机扣除挂机点数")
        START_GUA_JI_COST(18301, "开始挂机扣除挂机点数|点数={0}"),
        
        @ReasonDesc("合成道具消耗")
        ITEM_COMPOSE_COST(18401, "合成道具消耗|扣除道具Id={0}|扣除道具数量={1}|合成道具Id={2}|合成道具数量={3}"),
        
        @ReasonDesc("货币兑换银子消耗金子")
        CURRENCY_EXCHANGE_COST1(18410, "货币兑换银子消耗|获得银子数量={0}"),
        @ReasonDesc("货币兑换获得银子")
        CURRENCY_EXCHANGE_GIVE1(18411, "货币兑换获得银子|消耗金子数量={0}"),
        @ReasonDesc("货币兑换银票消耗金票")
        CURRENCY_EXCHANGE_COST2(18412, "货币兑换银票消耗金票|获得银票数量={0}"),
        @ReasonDesc("货币兑换获得银票")
        CURRENCY_EXCHANGE_GIVE2(18413, "货币兑换获得银票|消耗金票数量={0}"),
        @ReasonDesc("货币兑换消耗货币")
        CURRENCY_EXCHANGE_COST(18414, "货币兑换|消耗货币={0}|消耗数量={1}"),
        @ReasonDesc("货币兑换货币")
        CURRENCY_EXCHANGE_GIVE(18415, "货币兑换|兑换货币={0}|兑换数量={1}"),
        
        @ReasonDesc("购买月卡消耗")
        BUY_MONTH_CARD_COST(18416, "购买月卡消耗|扣除货币类型={0}|扣除货币数量={1}"),
        @ReasonDesc("购买月卡返利")
        BUY_MONTH_CARD_REBATE(18417, "购买月卡返利|返利货币类型={0}|返利货币数量={1}"),
        @ReasonDesc("领取月卡返利")
        MONTH_CARD_GIFT(18418, "领取月卡返利|返利货币类型={0}|返利货币数量={1}"),
    ...
    public enum PetExpLogReason implements ILogReason {
        ...
        @ReasonDesc("跑环任务奖励")
        RING_TASK_REWARD(144, "跑环任务奖励"),
        @ReasonDesc("吃道具经验奖励")
        ITEM_EXP_REWARD(145, "吃道具经验奖励"),
    ...
    public enum MallLogReason implements ILogReason {
        ...
        @ReasonDesc("兑换商城物品")
        EXCHANGE_ITEM(7, "兑换商城物品,costItemId = {0} , costNum = {1} , suitNum = {2}, mallItemId = {3}, itemId = {4}, itemNum = {5}"),
        ;
    ...
    @LogDesc(desc = "跑环任务日志")
    public enum RingTaskLogReason implements ILogReason {
    	@ReasonDesc("接受任务")
    	ACCEPT_TASK(1, "接受任务"),
    	@ReasonDesc("完成任务")
    	FINISH_TASK(2, "完成任务"),
    	...
    	private RingTaskLogReason(int reason, String reasonText) {
    		this.reason = reason;
    		this.reasonText = reasonText;
    	}
