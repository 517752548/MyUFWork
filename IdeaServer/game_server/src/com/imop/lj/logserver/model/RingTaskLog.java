...
public class RingTaskLog extends BaseLogMessage{
    ...
    public RingTaskLog(
        ...
        super(MessageType.LOG_RINGTASK_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_RINGTASK_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_RINGTASK_RECORD";
    }
}