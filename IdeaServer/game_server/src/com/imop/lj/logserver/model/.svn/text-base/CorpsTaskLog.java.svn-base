...
public class CorpsTaskLog extends BaseLogMessage{
    ...
    public CorpsTaskLog(
        ...
        super(MessageType.LOG_CORPSTASK_RECORD,logTime,regionId,serverId,accountId,accountName,charId,charName,level,countryId,vipLevel,totalCharge,deviceId,deviceType,deviceVersion,clientVersion,clientLanguage,appid,fValue,reason,param);
    ...
    public short getType() {
        return MessageType.LOG_CORPSTASK_RECORD;
    }

    @Override
    public String getTypeName() {
        return "LOG_CORPSTASK_RECORD";
    }
}