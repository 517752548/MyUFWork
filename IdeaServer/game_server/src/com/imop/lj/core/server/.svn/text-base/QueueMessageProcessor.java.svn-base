		...
		try {
			...
			if (logger.isInfoEnabled()) {
				...
				if (time > 1) {
					...
					logger.info("Message:" + msg.getTypeName() + ":"
							+ msg.getClass().getSimpleName()
							+ " Type:"
							+ type + " Time:" + time + "ms" + " Total:"
							+ this.statisticsMessageCount);
					
					if (type == 0 || msg.getClass().getSimpleName() == null || msg.getClass().getSimpleName().isEmpty()) {
						logger.info("Message:" + msg.getTypeName() + ":" + msg.getClass().getSimpleName() + ";f="
								+ msg.getClass().getName() + ";msg=" + msg.toString()
								+ " Type:"
								+ type + " Time:" + time + "ms");
					}
