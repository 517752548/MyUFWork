...
public class DataType {
	...
	@SuppressWarnings("unchecked")
	public static Object readObjectData(final IoBuffer buffer) {
	 ...
	 * @return
	 */
	public static Object readRawTypeData(final IoBuffer buffer) {
		final byte _dataType = buffer.get();
		switch (_dataType) {
		case IntType:
	 ...
	 *                在编码过程中出现错误会抛出此异常
	 */
	public static void writeString(String str, final IoBuffer buffer) {
	 ...
	 *                在编码过程中出现错误会抛出此异常
	 */
	public static String readString(final IoBuffer buffer) {
	 ...
	 *                在编码过程中出现错误会抛出此异常
	 */
	public static String readString(String charset, final IoBuffer buffer) {
	...
	private static final SimpleBufferAllocator allocator = new SimpleBufferAllocator();
	...
	public static byte[] obj2byte(Object object, int initLength) {
		...
		IoBuffer _buffer = allocator.allocate(initLength, false);
	...
	public static Object byte2obj(byte[] arrayData) {
		...
		IoBuffer _minaBuffer = allocator.wrap(_buffer);
