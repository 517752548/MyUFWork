...
import com.imop.lj.core.msg.property.PropertyBag.ValueType;

public class ProtocolUtils {
	private static final Logger logger = LoggerFactory.getLogger(ProtocolUtils.class);

	static void putValueIntoPkt(IoBuffer packet, ValueType type, Object value){
		switch (type) {
		case PNull:
			break;
		case PBoolean:
...
//			}
	...
	static Object readValueFromPkt(IoBuffer packet, ValueType type){
		Object value=null;
		switch (type) {
		case PNull:
			value = null;
