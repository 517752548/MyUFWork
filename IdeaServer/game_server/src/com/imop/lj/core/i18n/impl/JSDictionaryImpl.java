package com.imop.lj.core.i18n.impl;
...
public class JSDictionaryImpl implements I18NDictionary<Integer, String> {
	...
	public void load() {
		...
		try {
			...
			throw new RuntimeException(ErrorsUtil.error(com.imop.lj.common.constants.CommonErrorLogInfo.FILE_IO_FAIL, "Throw Exception", this.fileName), e);
		} catch (ScriptException se) {
			throw new RuntimeException(ErrorsUtil.error(com.imop.lj.common.constants.CommonErrorLogInfo.SCRITP_EXECUTE_FAIL, "Throw Exception", this.fileName), se);
		}
	}
