 ...
 * 
 */
public class PlotDungeonFunc extends AbstractFunc {

	public PlotDungeonFunc(Human human, FuncTypeEnum funcType) {
	...
	public boolean canShowEffect() {
		return Globals.getPlotDungeonService().canGetDailyPlotDungeonReward(getOwner());
	}
