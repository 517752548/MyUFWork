...
@ExcelRowBinding
public abstract class PetTrainCostTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetTrainCostTemplateVO[currencyTypeId=" + currencyTypeId + ",currencyNum=" + currencyNum + ",needVipLevel=" + needVipLevel + ",]";
