 ...
 *
 */
public class TimeLimitNpc extends AbstractTask<Human> implements PersistanceObject<String, TimeLimitNpcEntity> {
	...
	public TimeLimitNpc(Human owner, QuestTemplate template) {
	...
	public boolean onAcceptTaskImpl() {
		boolean flag = Globals.getTimeLimitNpcTaskService().onAcceptTaskImpl(getOwner(), this);
		return flag;
	}
	
	@Override
	protected boolean onFinishTaskImpl() {
		boolean flag = Globals.getTimeLimitNpcTaskService().onFinishTaskImpl(getOwner());
		return flag;
	}
	
	@Override
	public boolean onGiveupTaskImpl() {
		boolean flag = Globals.getTimeLimitNpcTaskService().onGiveupTaskImpl(getOwner());
		return flag;
	}
	...
	@Override
	public TimeLimitNpcEntity toEntity() {
		TimeLimitNpcEntity entity = new TimeLimitNpcEntity();
		entity.setId(getId());
	...
	@Override
	public void fromEntity(TimeLimitNpcEntity entity) {
		setId(entity.getId());
