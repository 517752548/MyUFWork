...
@ExcelRowBinding
public abstract class TheSweeneyTaskGroupTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "TheSweeneyTaskGroupTemplateVO[questGroupId=" + questGroupId + ",questId=" + questId + ",weight=" + weight + ",]";
