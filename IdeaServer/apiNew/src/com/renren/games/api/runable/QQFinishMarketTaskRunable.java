 ...
 * 
 */
public class QQFinishMarketTaskRunable extends ApiCallable {
	...
	public QQFinishMarketTaskRunable(Map<String, String> params, String uuid) {
		this.params = params;
		this.uuid = uuid;
	}
	...
	public String execute() {
		...
		try {
			...
			result = Globals.getQqMarketService().finishQQMarketTask(appid, openid, uuid, step);
		} catch (Exception e) {
