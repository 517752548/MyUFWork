...
using UnityEngine;
 ...
 public static class AddressablesBundleBuildScript
 {
     ...
     public static void CreatAssetViewConst(Dictionary<string, BuildAddressablesData> bundles)
     {
         ...
         if (File.Exists(Application.dataPath + "/Hotfix/ViewConst.cs"))
         {
             File.Delete(Application.dataPath + "/Hotfix/ViewConst.cs");
         }
         
         CreateTextFile(Application.dataPath + "/Hotfix/ViewConst.cs", temp);
     }
