    ...
    public struct Vector2: IEquatable<Vector2>
    {
        ...
        public override string ToString()
        {
            ...
            return string.Format(currentCulture, "{0}, {1}",
                new object[2] { this.x.ToString(currentCulture), this.y.ToString(currentCulture) });
        }
        ...
        public float magnitude => this.Length();

        public float sqrMagnitude => this.LengthSquared();
