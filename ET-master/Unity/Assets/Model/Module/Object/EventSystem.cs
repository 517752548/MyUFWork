...
namespace ET
{
	public sealed class EventSystem: IDisposable
	{
		...
		private EventSystem()
		{
			this.Add(typeof(EventSystem).FullName,typeof(EventSystem).Assembly);
		}

		public void Add(string clazzname,Assembly assembly)
		{
			this.assemblies[clazzname] = assembly;
			this.types.Clear();
		...
		public Assembly GetAssembly(string clazzname)
		{
			return this.assemblies[clazzname];
		}
