...
import com.imop.lj.gameserver.xianhu.persistance.XianhuRankUpdater;
import com.imop.lj.gameserver.xianhu.persistance.XianhuUpdater;
...
public class CommonDataUpdater extends AbstractSceneDataUpdater {
	...
	static {
        ...
        /** 仙葫 */
        operationDbMap.put(Xianhu.class, new XianhuUpdater());
        /** 仙葫排名 */
        operationDbMap.put(XianhuRank.class, new XianhuRankUpdater());
