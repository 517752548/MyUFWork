...
@ExcelRowBinding
public abstract class GemUpTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "GemUpTemplateVO[costGold=" + costGold + ",itemId1=" + itemId1 + ",itemNum1=" + itemNum1 + ",itemId2=" + itemId2 + ",itemNum2=" + itemNum2 + ",]";
