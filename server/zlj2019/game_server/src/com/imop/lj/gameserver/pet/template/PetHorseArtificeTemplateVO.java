...
@ExcelRowBinding
public abstract class PetHorseArtificeTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorseArtificeTemplateVO[itemId=" + itemId + ",itemNum=" + itemNum + ",currencyNum=" + currencyNum + ",currencyType=" + currencyType + ",perceptionLevel=" + perceptionLevel + ",minQuality=" + minQuality + ",maxQuality=" + maxQuality + ",name=" + name + ",]";
