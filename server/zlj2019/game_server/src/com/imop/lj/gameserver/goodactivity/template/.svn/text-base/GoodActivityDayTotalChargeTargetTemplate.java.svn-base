 ...
 */
@ExcelRowBinding
public class GoodActivityDayTotalChargeTargetTemplate extends GoodActivityDayTotalChargeTargetTemplateVO {
	...
	public void check() throws TemplateConfigException {
		...
		if (rewardTpl.getRewardReasonType() != RewardReasonType.GA_DAY_TOTAL_CHARGE) {
	...
	public GoodActivityType getGoodActivityType() {
		return GoodActivityType.DAY_TOTAL_CHARGE;
	}
