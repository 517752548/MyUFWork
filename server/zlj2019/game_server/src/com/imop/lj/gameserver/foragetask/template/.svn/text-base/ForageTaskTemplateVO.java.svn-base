...
@ExcelRowBinding
public abstract class ForageTaskTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "ForageTaskTemplateVO[levelMin=" + levelMin + ",levelMax=" + levelMax + ",questGroupId=" + questGroupId + ",weight=" + weight + ",]";
