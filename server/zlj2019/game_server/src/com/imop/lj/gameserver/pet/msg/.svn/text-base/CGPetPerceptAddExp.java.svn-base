 ...
 */
public class CGPetPerceptAddExp extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_PET_PERCEPT_ADD_EXP;
	}
	
	@Override
	public String getTypeName() {
		return "CG_PET_PERCEPT_ADD_EXP";
	}
	...
	@Override
	public void execute() {
		PetHandlerFactory.getHandler().handlePetPerceptAddExp(this.getSession().getPlayer(), this);
	}
}