...
public class PetDef {
	...
	/** 技能默认层数 */
	public static final int DEFAULT_SKILL_LAYER = 1;
	/** 技能默认熟练度,0*/
	public static final int DEFAULT_SKILL_PROFICIENCY = 0;
	
	public static final String PET_TRAIN_PROP_KEY = "1";
	public static final String PET_TRAIN_TEMP_PROP_KEY = "2";
	
	/** 资质丹索引*/
	public static final String PET_PROP_ITEM_INDEX_KEY = "1";
	/** 资质丹加成*/
	public static final String PET_ITEM_PROP_KEY = "2";
	/**
	 * 武将类型定义
	 */
	 ...
	 *
	 */
	public static enum GrowthWeightType implements IndexedEnum {
		/** 普通 */
		NORMAL(0),
		/** 垃圾 */
		RUBBISHY(1),
		...
		private GrowthWeightType(int index) {
			this.index = index;
		}
		...
		private static final List<GrowthWeightType> values = IndexedEnumUtil
				.toIndexes(GrowthWeightType.values());
		
		public static GrowthWeightType valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	 ...
	 * 宠物资质丹加成定义
	 */
	public static enum PetPropAddType implements IndexedEnum {
		/**强壮资质*/
		STRENGTH(6),
		/**敏捷资质*/
		AGILITY(7),
		...
		private PetPropAddType(int index) {
			this.index = index;
		}
		...
		private static final List<PetPropAddType> values = IndexedEnumUtil.toIndexes(PetPropAddType.values());
		
		public static PetPropAddType valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	}
	 ...
	 * 骑宠灵魂链接操作定义
	 */
	public static enum PetHorseSoulLinkType implements IndexedEnum {
		/**取消*/
		CANCEL(0),
		/**增加*/
		ADD(1),
		...
		private PetHorseSoulLinkType(int index) {
			this.index = index;
		}
		...
		private static final List<PetHorseSoulLinkType> values = IndexedEnumUtil.toIndexes(PetHorseSoulLinkType.values());
		
		public static PetHorseSoulLinkType valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	}
