...
public abstract class PetTalentSkillNumTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetTalentSkillNumTemplateVO[affiMinNum=" + affiMinNum + ",affiMaxNum=" + affiMaxNum + ",talentSkillNum=" + talentSkillNum + ",weight=" + weight + ",talentSkill1Flag=" + talentSkill1Flag + ",variationFlag=" + variationFlag + ",growthFlag=" + growthFlag + ",]";
