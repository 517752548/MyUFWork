...
@ExcelRowBinding
public abstract class PetPropItemTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetPropItemTemplateVO[propIndex=" + propIndex + ",propItemIndex=" + propItemIndex + ",itemId=" + itemId + ",]";
