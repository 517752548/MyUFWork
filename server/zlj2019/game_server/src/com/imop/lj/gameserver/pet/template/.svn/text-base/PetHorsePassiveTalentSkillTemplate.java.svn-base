 ...
 */
@ExcelRowBinding
public class PetHorsePassiveTalentSkillTemplate extends PetHorsePassiveTalentSkillTemplateVO {
	...
	public void check() throws TemplateConfigException {
		...
		//必须是天赋技能，且为被动
		if (!skillTpl.isPassive() || skillTpl.getSkillType() != SkillType.PET_HORSE_TALENT) {
			throw new TemplateConfigException(this.sheetName, this.id, "技能Id在技能配置表不是骑宠被动天赋技能！");
		}
