...
import com.imop.lj.gameserver.across.cdkeyworld.handler.CdkeyworldAcrossHandlerFactory;
...
public class WGCdkeyCheckResultMsg extends WGMessage{
	...
	@Override
	public void execute() {
		CdkeyworldAcrossHandlerFactory.getHandler().handleCdkeyCheckResultMsg(this);
	}
}