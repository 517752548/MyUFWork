...
import com.imop.lj.gameserver.command.impl.UpgradeHumanSkillCmd;
import com.imop.lj.gameserver.command.impl.XianhuCmd;
...
public class CommandBaseProcessorGameServer <T extends ISession> extends
	...
	public void register(ICommandProcessor<ISession> cmdProcessor) {
		...
		cmdProcessor.registerCommand(new UpgradeHumanSkillCmd());
		cmdProcessor.registerCommand(new XianhuCmd());
