 ...
 */
public class CGPetStudyNormalSkill extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_PET_STUDY_NORMAL_SKILL;
	}
	
	@Override
	public String getTypeName() {
		return "CG_PET_STUDY_NORMAL_SKILL";
	}
	...
	@Override
	public void execute() {
		PetHandlerFactory.getHandler().handlePetStudyNormalSkill(this.getSession().getPlayer(), this);
	}
}