...
public class LeaderMindALevelXDest extends AbstractQuestDestination {
	private int mindSkillLevel;
	
	public LeaderMindALevelXDest(int questId, int leaderLevel) {
		super(questId);
	...
	public DestType getDestType() {
		return DestType.LEADER_MIND_A_LEVEL_X;
	}
	...
	public Object getInstKey() {
		return "LEADER_MIND_A_LEVEL_" + this.mindSkillLevel;
	}
