...
@ExcelRowBinding
public abstract class TimeLimitNpcTemplateVO extends TemplateObject {
	...
	public void setAssistRewardId(int assistRewardId) {
		if (assistRewardId < 1) {
			throw new TemplateConfigException(this.getSheetName(), this.getId(),
					6, "[玩家助战奖励ID]assistRewardId的值不得小于1");
		}
	...
	public String toString() {
		return "TimeLimitNpcTemplateVO[levelMin=" + levelMin + ",levelMax=" + levelMax + ",questId=" + questId + ",weight=" + weight + ",assistRewardId=" + assistRewardId + ",]";
