...
public class PetGemBag extends AbstractGemBag {
	...
	public PetGemBag(Human owner, Role wearer) {
		//FIXME
		super(owner, wearer, BagType.NULL, RoleConstants.PET_GEM_BAG_CAPACITY);
	}
	...
	public void addGem(Item to, ItemTemplate temp, ItemGenLogReason reason, String detailReason) {
		Item newItem = Globals.getItemService().newActivatedInstance(this.getOwner(), temp, to.getBagType(), to.getIndex(), 1, true);
