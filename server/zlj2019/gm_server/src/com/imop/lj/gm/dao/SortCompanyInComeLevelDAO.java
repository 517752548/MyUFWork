...
public class SortCompanyInComeLevelDAO extends GenericDAO {
//	/**
//	 * 公司收入排行榜排名
//	 *
//	 * @return
...
//	public List<SortCompanyIncomeLevelEntity> getSortCompanyIncomeLevelList(final String type,
...
//		return (List<SortCompanyIncomeLevelEntity>) getTemplate().doCall(
//				new HibernateCallback<List>() {
//					@Override
//					public List doCall(Session session) {
//						StringBuffer sql = new StringBuffer();
//						sql.append("select * from t_sort_companyIncomelevel where 1=1");
...
//						}
//
//						LogTypeUtils.addQueryScalar(query, SortCompanyIncomeLevelEntity.class);
//						query.setResultTransformer(Transformers
//								.aliasToBean(SortCompanyIncomeLevelEntity.class));
