...
public class GameConstants implements Config {
    ...
    //骑宠最大忠诚度
    public int petHorseMaxLoy = 100;
    //骑宠出战最低忠诚度
    public int PetHorseFightLoyMin = 10;
    //骑宠出战战斗胜利增加忠诚度
    public int petHorseFightWinAddLoy = 10;
    //骑宠出战战斗失败减少忠诚度
    public int petHorseFightLossMiusLoy = 20;
    /**
     * 骑宠初始亲密度
     */
    public int PetHorseInitClo = 60;
    //骑宠最大亲密度
    public int petHorseMaxClo = 100;
    //骑宠出战战斗胜利增加亲密度
    public int petHorseFightWinAddClo = 10;
    //骑宠出战战斗失败减少亲密度
    public int petHorseFightLossMiusClo = 20;
    //非骑乘状态每达到N小时，降低XX点
    public int petHorseNotFightHour = 1;
    //非骑乘状态每达到N小时，降低XX点
    public int petHorseNotFightMinusClo = 15;
    //续租最小时间,毫秒
    public int petHorseReletTime = 1 * 60 * 60 * 1000;
     ...
     * 宠物默认技能栏数量
     */
    public int petDefaultSkillBarNum = 5;
    
    public int petMaxSkillBarNum = 10;// 宠物技能栏最大数量
    
    public int skillBarNumItemId = 20190;//扩充宠物技能栏道具Id
    public int addSkillBarNum = 1; //扩充宠物技能栏数量
    /**
     * 宠物技能等级上限
     */
     ...
     * 宠物被捕捉时，天赋技能数量上限
     */
    public int petTalentSkillNumMaxOnCaught = 2;
    /**
     * 宠物洗天赋技能需要的道具Id
     */
    public int petTalentSkillResetItemId = 10034;
    /**
     * 神兽洗天赋技能需要的道具Id
     */
    public int bestPetTalentSkillResetItemId = 10158;
    /**
     * 骑宠洗天赋技能需要的道具Id
     */
    public int petHorseTalentSkillResetItemId = 10034;
    /**
     * 神兽骑宠洗天赋技能需要的道具Id
     */
    public int bestPetHorseTalentSkillResetItemId = 10158;
    /**
     * 宠物洗天赋技能需要的道具数量
     */
    public int petTalentSkillResetItemNum = 5;
    public int petTalentSkillResetLifeNum = 10;//宠物洗天赋技能需要的寿命数量
    public int petTalentSkillNumMaxOnReset = 1; //成功无洗天赋技能时,天赋技能数量上限
    public int petUpPerceptLevelAddTalentSkillRate = 100;//宠物悟性等级提升可增加成功率,扩大100倍
    public double petPropItemCoef1 = 2.0d; //资质丹加成系数1
    public double petPropItemCoef2 = 3.0d; //资质丹加成系数2
    public int petAffinationMod = 10000; //宠物还童次数最大值
    /**
     * 骑宠洗天赋技能需要的道具数量
     */
    public int petHorseTalentSkillResetItemNum = 5;
    public int petHorseTalentSkillResetLifeNum = 10;//骑宠洗天赋技能需要的寿命数量
    public int petHorseTalentSkillNumMaxOnReset = 1; //成功无洗天赋技能时,天赋技能数量上限
    public int petHorseUpPerceptLevelAddTalentSkillRate = 100;//骑宠悟性等级提升可增加成功率,扩大100倍
    public double petHorsePropItemCoef1 = 2.0d; //资质丹加成系数1
    public double petHorsePropItemCoef2 = 3.0d; //资质丹加成系数2
    public int petHorseAffinationMod = 10000; //宠物还童次数最大值
    /**
     * 宠物炼化类型 1 炼化
     */
    ...
    //月卡天数
    private int monthCardDayNum = 30;
    
    /**
     * 跑环相关
     */
    private int ringToRoundNumCoef = 10;
    ...
    //装备宝石孔最大数
    private int gemHoleMaxNum = 10;
    
    //一个装备同一颜色的孔数最大值
    private int equipHoleColorMax = 6;
    
    //镶嵌低级成功率
    private double gemUpNormalProb = 0.8d;
	//镶嵌高级成功率
    private double gemUpGoodProb = 1.0d;
    //摘除低级成功率
    private double gemDownNormalProb = 0.8d;
	//摘除高级成功率
    private double gemDownGoodProb = 1.0d;
	//宝石降低等级数
    private int gemLevelCoef = 2;
     ...
     * 计算类经验相关
     */
    //power(round(等级/10,0),指数幂)*经验基数*(1+(MOD(等级,10)-5)/100))/20
    //计算类经验系数1
    private int calculateExpCoef1 = 10;
    //计算类经验系数2
    private int calculateExpCoef2 = 5;
    //计算类经验系数3
    private int calculateExpCoef3 = 100;
    
    //酒馆经验系数
    private int pubExpCoef = 20;
    //科举经验系数
    private int examExpCoef = 20;
    //科举答错题系数
    private int examWrongAnswerCoef = 2; 
    //绿野仙踪boss经验系数
    private int wizardRaidBossExpCoef = 12;
    //绿野仙踪副本经验系数
    private int wizardRaidExpCoef = 4;
    //封印小妖经验系数
    private int sealDemonExpCoef = 10;
    //跑环任务经验系数
    private int ringExpCoef = 20;
    
    //酒馆计算奖励Id
    private int calculateExpPubRewardId = 2777;
    //封印小妖计算奖励Id
    private int calculateExpSealDemonRewardId = 2777;
	...
	//技能熟练度升级 任务Id
	private int guideSubSkillProQuestId = 10005;
	//心法升级 任务Id
	private int guideMindLevelupQuestId = 10011;
	//技能升级 任务Id
	private int guideSkillLevelupQuestId = 1022;
	...
	//打造装备等级限制
	private int craftEquipLevelLimit = 20;
	//打造装备材料数量上限
	private int craftEquipItemNumMax = 999;

	/**
	 * 心法技能
	 */
	//提升技能等级满足默认层数
	private int subSkillMinUpgradeLayer = 8;
	//技能等级最大层数
	private int subSkillMaxLayer = 10;
	//技能升级所需技能书数量
	private int subSkillUpgradeBookNum = 1;
	//技能等级最大等级
	private int subSkillMaxLevel= 10;
	
	//技能快捷栏最小最小索引值
	private int subSKillMinShortcutIndex = 0;
	//技能快捷栏最大数量
	private int subSkillMaxShortcutNum = 6;
	//增加技能熟练度道具Id
	private int addProficiencyItemId = 20189;
	//使用技能熟练度道具数量
	private int useAddProficiencyItemNum = 1;
	//增加技能熟练度数量
	private int addProficiencyNum = 5;
	
	/**
	 * 生活技能
	 */
	//技能等级最大层数
	private int lifeSkillMaxLayer = 8;
	//技能升级所需技能书数量
	private int lifeSkillUpgradeBookNum = 1;
	//技能等级最大等级
	private int lifeSkillMaxLevel= 6;
	//生活技能消耗时间,10秒
	private int lifeSkillCostCD = 10 * 1000;
	//修正时间1秒
	private int deltaTime = 1500;
	//生活技能消耗MP
	private int lifeSkillCostMP = 10;
	
	//增加技能熟练度数量
	private int addLifeProficiencyNum = 5;
    //生活技能判断是否在范围内的偏移量(半径)
    private int lifePointInAreaOffset = 2;
	 ...
	 */
	//祝福仙葫开启消耗银子系数
	private int xianhuZhufuCostCoef = 10;
	//祝福仙葫奖励Id
	private int xianhuZhufuRewardId = 1001;
	//祝福祈福仙葫显示奖励Id
	private int xianhuShowRewardId = 1001;
	
	//祈福仙葫开启消耗金子数
	private int xianhuQifuCostBond = 10;
	//祈福仙葫奖励Id
	private int xianhuQifuRewardId = 1002;
	//祈福仙葫每日最大次数
	private int xianhuQifuMaxNum = 9999;
	//祈福仙葫每10次额外奖励次数定义
	private int xianhuQifuExtra1Num = 10;
	//祈福仙葫每50次额外奖励次数定义
	private int xianhuQifuExtra2Num = 50;
	//富贵仙葫奖励id
	private int xianhuFuguiRewardId = 1001;
	//至尊仙葫奖励id
	private int xianhuZhizunRewardId = 1002;
	//富贵仙葫显示奖励id
	private int xianhuFuguiShowRewardId = 1001;
	//至尊仙葫显示奖励id
	private int xianhuZhizunShowRewardId = 1002;
	 ...
	 */
	//挂机点公式系数
	private double guaJiProb = 1.0d;
	//免费挂机点上限
	private long guaJiPointMaxNum = 999;
	...
	public int getBestPetTalentSkillResetItemId() {
		return bestPetTalentSkillResetItemId;
	}

	public void setBestPetTalentSkillResetItemId(int bestPetTalentSkillResetItemId) {
		this.bestPetTalentSkillResetItemId = bestPetTalentSkillResetItemId;
	}
	...
	public void setPetHorseFightLoyMin(int petHorseFightLoyMin) {
		this.PetHorseFightLoyMin = petHorseFightLoyMin;
	}
	...
	public void setPetHorseInitLoy(int petHorseInitLoy) {
		this.PetHorseInitLoy = petHorseInitLoy;
	}
	...
	public void setPetHorseInitClo(int petHorseInitClo) {
		this.PetHorseInitClo = petHorseInitClo;
	}
	...
	public int getCraftEquipLevelLimit() {
		return craftEquipLevelLimit;
	}

	public void setCraftEquipLevelLimit(int craftEquipLevelLimit) {
		this.craftEquipLevelLimit = craftEquipLevelLimit;
	}

	public int getCraftEquipItemNumMax() {
		return craftEquipItemNumMax;
	}

	public void setCraftEquipItemNumMax(int craftEquipItemNumMax) {
		this.craftEquipItemNumMax = craftEquipItemNumMax;
	}

	public int getSubSkillMinUpgradeLayer() {
		return subSkillMinUpgradeLayer;
	}

	public void setSubSkillMinUpgradeLayer(int subSkillMinUpgradeLayer) {
		this.subSkillMinUpgradeLayer = subSkillMinUpgradeLayer;
	}

	public int getSubSkillMaxLayer() {
		return subSkillMaxLayer;
	}

	public void setSubSkillMaxLayer(int subSkillMaxLayer) {
		this.subSkillMaxLayer = subSkillMaxLayer;
	}

	public int getSubSkillUpgradeBookNum() {
		return subSkillUpgradeBookNum;
	}

	public void setSubSkillUpgradeBookNum(int subSkillUpgradeBookNum) {
		this.subSkillUpgradeBookNum = subSkillUpgradeBookNum;
	}

	public int getSubSkillMaxLevel() {
		return subSkillMaxLevel;
	}

	public void setSubSkillMaxLevel(int subSkillMaxLevel) {
		this.subSkillMaxLevel = subSkillMaxLevel;
	}

	public int getSubSKillMinShortcutIndex() {
		return subSKillMinShortcutIndex;
	}

	public void setSubSKillMinShortcutIndex(int subSKillMinShortcutIndex) {
		this.subSKillMinShortcutIndex = subSKillMinShortcutIndex;
	}

	public int getSubSkillMaxShortcutNum() {
		return subSkillMaxShortcutNum;
	}

	public void setSubSkillMaxShortcutNum(int subSkillMaxShortcutNum) {
		this.subSkillMaxShortcutNum = subSkillMaxShortcutNum;
	}

	public int getAddProficiencyItemId() {
		return addProficiencyItemId;
	}

	public void setAddProficiencyItemId(int addProficiencyItemId) {
		this.addProficiencyItemId = addProficiencyItemId;
	}

	public int getUseAddProficiencyItemNum() {
		return useAddProficiencyItemNum;
	}

	public void setUseAddProficiencyItemNum(int useAddProficiencyItemNum) {
		this.useAddProficiencyItemNum = useAddProficiencyItemNum;
	}

	public int getAddProficiencyNum() {
		return addProficiencyNum;
	}

	public void setAddProficiencyNum(int addProficiencyNum) {
		this.addProficiencyNum = addProficiencyNum;
	}

	public int getGemHoleMaxNum() {
		return gemHoleMaxNum;
	}

	public void setGemHoleMaxNum(int gemHoleMaxNum) {
		this.gemHoleMaxNum = gemHoleMaxNum;
	}

	public int getEquipHoleColorMax() {
		return equipHoleColorMax;
	}

	public void setEquipHoleColorMax(int equipHoleColorMax) {
		this.equipHoleColorMax = equipHoleColorMax;
	}

	public double getGemUpNormalProb() {
		return gemUpNormalProb;
	}

	public void setGemUpNormalProb(double gemUpNormalProb) {
		this.gemUpNormalProb = gemUpNormalProb;
	}

	public double getGemUpGoodProb() {
		return gemUpGoodProb;
	}

	public void setGemUpGoodProb(double gemUpGoodProb) {
		this.gemUpGoodProb = gemUpGoodProb;
	}

	public int getGemLevelCoef() {
		return gemLevelCoef;
	}

	public void setGemLevelCoef(int gemLevelCoef) {
		this.gemLevelCoef = gemLevelCoef;
	}

	public double getGemDownNormalProb() {
		return gemDownNormalProb;
	}

	public void setGemDownNormalProb(double gemDownNormalProb) {
		this.gemDownNormalProb = gemDownNormalProb;
	}

	public double getGemDownGoodProb() {
		return gemDownGoodProb;
	}

	public void setGemDownGoodProb(double gemDownGoodProb) {
		this.gemDownGoodProb = gemDownGoodProb;
	}

	public int getPetDefaultSkillBarNum() {
		return petDefaultSkillBarNum;
	}

	public void setPetDefaultSkillBarNum(int petDefaultSkillBarNum) {
		this.petDefaultSkillBarNum = petDefaultSkillBarNum;
	}

	public int getSkillBarNumItemId() {
		return skillBarNumItemId;
	}

	public void setSkillBarNumItemId(int skillBarNumItemId) {
		this.skillBarNumItemId = skillBarNumItemId;
	}

	public int getAddSkillBarNum() {
		return addSkillBarNum;
	}

	public void setAddSkillBarNum(int addSkillBarNum) {
		this.addSkillBarNum = addSkillBarNum;
	}

	public int getPetMaxSkillBarNum() {
		return petMaxSkillBarNum;
	}

	public void setPetMaxSkillBarNum(int petMaxSkillBarNum) {
		this.petMaxSkillBarNum = petMaxSkillBarNum;
	}

	public int getPetTalentSkillResetLifeNum() {
		return petTalentSkillResetLifeNum;
	}

	public void setPetTalentSkillResetLifeNum(int petTalentSkillResetLifeNum) {
		this.petTalentSkillResetLifeNum = petTalentSkillResetLifeNum;
	}

	public int getPetTalentSkillNumMaxOnReset() {
		return petTalentSkillNumMaxOnReset;
	}

	public void setPetTalentSkillNumMaxOnReset(int petTalentSkillNumMaxOnReset) {
		this.petTalentSkillNumMaxOnReset = petTalentSkillNumMaxOnReset;
	}

	public int getPetUpPerceptLevelAddTalentSkillRate() {
		return petUpPerceptLevelAddTalentSkillRate;
	}

	public void setPetUpPerceptLevelAddTalentSkillRate(int petUpPerceptLevelAddTalentSkillRate) {
		this.petUpPerceptLevelAddTalentSkillRate = petUpPerceptLevelAddTalentSkillRate;
	}

	public double getPetPropItemCoef1() {
		return petPropItemCoef1;
	}

	public void setPetPropItemCoef1(double petPropItemCoef1) {
		this.petPropItemCoef1 = petPropItemCoef1;
	}

	public double getPetPropItemCoef2() {
		return petPropItemCoef2;
	}

	public void setPetPropItemCoef2(double petPropItemCoef2) {
		this.petPropItemCoef2 = petPropItemCoef2;
	}

	public int getPetAffinationMod() {
		return petAffinationMod;
	}

	public void setPetAffinationMod(int petAffinationMod) {
		this.petAffinationMod = petAffinationMod;
	}

	public int getXianhuZhufuCostCoef() {
		return xianhuZhufuCostCoef;
	}

	public void setXianhuZhufuCostCoef(int xianhuZhufuCostCoef) {
		this.xianhuZhufuCostCoef = xianhuZhufuCostCoef;
	}

	public int getXianhuZhufuRewardId() {
		return xianhuZhufuRewardId;
	}

	public void setXianhuZhufuRewardId(int xianhuZhufuRewardId) {
		this.xianhuZhufuRewardId = xianhuZhufuRewardId;
	}

	public int getXianhuQifuCostBond() {
		return xianhuQifuCostBond;
	}

	public void setXianhuQifuCostBond(int xianhuQifuCostBond) {
		this.xianhuQifuCostBond = xianhuQifuCostBond;
	}

	public int getXianhuQifuRewardId() {
		return xianhuQifuRewardId;
	}

	public void setXianhuQifuRewardId(int xianhuQifuRewardId) {
		this.xianhuQifuRewardId = xianhuQifuRewardId;
	}

	public int getXianhuQifuMaxNum() {
		return xianhuQifuMaxNum;
	}

	public void setXianhuQifuMaxNum(int xianhuQifuMaxNum) {
		this.xianhuQifuMaxNum = xianhuQifuMaxNum;
	}

	public int getXianhuQifuExtra1Num() {
		return xianhuQifuExtra1Num;
	}

	public void setXianhuQifuExtra1Num(int xianhuQifuExtra1Num) {
		this.xianhuQifuExtra1Num = xianhuQifuExtra1Num;
	}

	public int getXianhuQifuExtra2Num() {
		return xianhuQifuExtra2Num;
	}

	public void setXianhuQifuExtra2Num(int xianhuQifuExtra2Num) {
		this.xianhuQifuExtra2Num = xianhuQifuExtra2Num;
	}

	public int getXianhuShowRewardId() {
		return xianhuShowRewardId;
	}

	public void setXianhuShowRewardId(int xianhuShowRewardId) {
		this.xianhuShowRewardId = xianhuShowRewardId;
	}

	public int getXianhuFuguiRewardId() {
		return xianhuFuguiRewardId;
	}

	public void setXianhuFuguiRewardId(int xianhuFuguiRewardId) {
		this.xianhuFuguiRewardId = xianhuFuguiRewardId;
	}

	public int getXianhuZhizunRewardId() {
		return xianhuZhizunRewardId;
	}

	public void setXianhuZhizunRewardId(int xianhuZhizunRewardId) {
		this.xianhuZhizunRewardId = xianhuZhizunRewardId;
	}

	public int getXianhuFuguiShowRewardId() {
		return xianhuFuguiShowRewardId;
	}

	public void setXianhuFuguiShowRewardId(int xianhuFuguiShowRewardId) {
		this.xianhuFuguiShowRewardId = xianhuFuguiShowRewardId;
	}

	public int getXianhuZhizunShowRewardId() {
		return xianhuZhizunShowRewardId;
	}

	public void setXianhuZhizunShowRewardId(int xianhuZhizunShowRewardId) {
		this.xianhuZhizunShowRewardId = xianhuZhizunShowRewardId;
	}

	public double getGuaJiProb() {
		return guaJiProb;
	}

	public void setGuaJiProb(double guaJiProb) {
		this.guaJiProb = guaJiProb;
	}

	public long getGuaJiPointMaxNum() {
		return guaJiPointMaxNum;
	}

	public void setGuaJiPointMaxNum(long guaJiPointMaxNum) {
		this.guaJiPointMaxNum = guaJiPointMaxNum;
	}

	public int getLifeSkillMaxLayer() {
		return lifeSkillMaxLayer;
	}

	public void setLifeSkillMaxLayer(int lifeSkillMaxLayer) {
		this.lifeSkillMaxLayer = lifeSkillMaxLayer;
	}

	public int getLifeSkillUpgradeBookNum() {
		return lifeSkillUpgradeBookNum;
	}

	public void setLifeSkillUpgradeBookNum(int lifeSkillUpgradeBookNum) {
		this.lifeSkillUpgradeBookNum = lifeSkillUpgradeBookNum;
	}

	public int getLifeSkillMaxLevel() {
		return lifeSkillMaxLevel;
	}

	public void setLifeSkillMaxLevel(int lifeSkillMaxLevel) {
		this.lifeSkillMaxLevel = lifeSkillMaxLevel;
	}

	public int getLifeSkillCostCD() {
		return lifeSkillCostCD;
	}

	public void setLifeSkillCostCD(int lifeSkillCostCD) {
		this.lifeSkillCostCD = lifeSkillCostCD;
	}

	public int getLifeSkillCostMP() {
		return lifeSkillCostMP;
	}

	public void setLifeSkillCostMP(int lifeSkillCostMP) {
		this.lifeSkillCostMP = lifeSkillCostMP;
	}

	public int getAddLifeProficiencyNum() {
		return addLifeProficiencyNum;
	}

	public void setAddLifeProficiencyNum(int addLifeProficiencyNum) {
		this.addLifeProficiencyNum = addLifeProficiencyNum;
	}

	public int getLifePointInAreaOffset() {
		return lifePointInAreaOffset;
	}

	public void setLifePointInAreaOffset(int lifePointInAreaOffset) {
		this.lifePointInAreaOffset = lifePointInAreaOffset;
	}
	...
	public int getPetHorseTalentSkillResetItemId() {
		return petHorseTalentSkillResetItemId;
	}

	public void setPetHorseTalentSkillResetItemId(int petHorseTalentSkillResetItemId) {
		this.petHorseTalentSkillResetItemId = petHorseTalentSkillResetItemId;
	}

	public int getBestPetHorseTalentSkillResetItemId() {
		return bestPetHorseTalentSkillResetItemId;
	}

	public void setBestPetHorseTalentSkillResetItemId(int bestPetHorseTalentSkillResetItemId) {
		this.bestPetHorseTalentSkillResetItemId = bestPetHorseTalentSkillResetItemId;
	}

	public int getPetHorseMaxLoy() {
		return petHorseMaxLoy;
	}

	public void setPetHorseMaxLoy(int petHorseMaxLoy) {
		this.petHorseMaxLoy = petHorseMaxLoy;
	}

	public int getPetHorseFightWinAddLoy() {
		return petHorseFightWinAddLoy;
	}

	public void setPetHorseFightWinAddLoy(int petHorseFightWinAddLoy) {
		this.petHorseFightWinAddLoy = petHorseFightWinAddLoy;
	}

	public int getPetHorseFightLossMiusLoy() {
		return petHorseFightLossMiusLoy;
	}

	public void setPetHorseFightLossMiusLoy(int petHorseFightLossMiusLoy) {
		this.petHorseFightLossMiusLoy = petHorseFightLossMiusLoy;
	}

	public int getPetHorseMaxClo() {
		return petHorseMaxClo;
	}

	public void setPetHorseMaxClo(int petHorseMaxClo) {
		this.petHorseMaxClo = petHorseMaxClo;
	}

	public int getPetHorseFightWinAddClo() {
		return petHorseFightWinAddClo;
	}

	public void setPetHorseFightWinAddClo(int petHorseFightWinAddClo) {
		this.petHorseFightWinAddClo = petHorseFightWinAddClo;
	}

	public int getPetHorseFightLossMiusClo() {
		return petHorseFightLossMiusClo;
	}

	public void setPetHorseFightLossMiusClo(int petHorseFightLossMiusClo) {
		this.petHorseFightLossMiusClo = petHorseFightLossMiusClo;
	}

	public int getPetHorseNotFightHour() {
		return petHorseNotFightHour;
	}

	public void setPetHorseNotFightHour(int petHorseNotFightHour) {
		this.petHorseNotFightHour = petHorseNotFightHour;
	}

	public int getPetHorseNotFightMinusClo() {
		return petHorseNotFightMinusClo;
	}

	public void setPetHorseNotFightMinusClo(int petHorseNotFightMinusClo) {
		this.petHorseNotFightMinusClo = petHorseNotFightMinusClo;
	}

	public int getPetHorseReletTime() {
		return petHorseReletTime;
	}

	public void setPetHorseReletTime(int petHorseReletTime) {
		this.petHorseReletTime = petHorseReletTime;
	}

	public int getPetHorseTalentSkillResetItemNum() {
		return petHorseTalentSkillResetItemNum;
	}

	public void setPetHorseTalentSkillResetItemNum(int petHorseTalentSkillResetItemNum) {
		this.petHorseTalentSkillResetItemNum = petHorseTalentSkillResetItemNum;
	}

	public int getPetHorseTalentSkillResetLifeNum() {
		return petHorseTalentSkillResetLifeNum;
	}

	public void setPetHorseTalentSkillResetLifeNum(int petHorseTalentSkillResetLifeNum) {
		this.petHorseTalentSkillResetLifeNum = petHorseTalentSkillResetLifeNum;
	}

	public int getPetHorseTalentSkillNumMaxOnReset() {
		return petHorseTalentSkillNumMaxOnReset;
	}

	public void setPetHorseTalentSkillNumMaxOnReset(int petHorseTalentSkillNumMaxOnReset) {
		this.petHorseTalentSkillNumMaxOnReset = petHorseTalentSkillNumMaxOnReset;
	}

	public int getPetHorseUpPerceptLevelAddTalentSkillRate() {
		return petHorseUpPerceptLevelAddTalentSkillRate;
	}

	public void setPetHorseUpPerceptLevelAddTalentSkillRate(int petHorseUpPerceptLevelAddTalentSkillRate) {
		this.petHorseUpPerceptLevelAddTalentSkillRate = petHorseUpPerceptLevelAddTalentSkillRate;
	}

	public double getPetHorsePropItemCoef1() {
		return petHorsePropItemCoef1;
	}

	public void setPetHorsePropItemCoef1(double petHorsePropItemCoef1) {
		this.petHorsePropItemCoef1 = petHorsePropItemCoef1;
	}

	public double getPetHorsePropItemCoef2() {
		return petHorsePropItemCoef2;
	}

	public void setPetHorsePropItemCoef2(double petHorsePropItemCoef2) {
		this.petHorsePropItemCoef2 = petHorsePropItemCoef2;
	}

	public int getPetHorseAffinationMod() {
		return petHorseAffinationMod;
	}

	public void setPetHorseAffinationMod(int petHorseAffinationMod) {
		this.petHorseAffinationMod = petHorseAffinationMod;
	}

	public int getMonthCardDayNum() {
		return monthCardDayNum;
	}

	public void setMonthCardDayNum(int monthCardDayNum) {
		this.monthCardDayNum = monthCardDayNum;
	}

	public int getRingToRoundNumCoef() {
		return ringToRoundNumCoef;
	}

	public void setRingToRoundNumCoef(int ringToRoundNumCoef) {
		this.ringToRoundNumCoef = ringToRoundNumCoef;
	}

	public int getCalculateExpCoef1() {
		return calculateExpCoef1;
	}

	public void setCalculateExpCoef1(int calculateExpCoef1) {
		this.calculateExpCoef1 = calculateExpCoef1;
	}

	public int getCalculateExpCoef2() {
		return calculateExpCoef2;
	}

	public void setCalculateExpCoef2(int calculateExpCoef2) {
		this.calculateExpCoef2 = calculateExpCoef2;
	}

	public int getCalculateExpCoef3() {
		return calculateExpCoef3;
	}

	public void setCalculateExpCoef3(int calculateExpCoef3) {
		this.calculateExpCoef3 = calculateExpCoef3;
	}

	public int getPubExpCoef() {
		return pubExpCoef;
	}

	public void setPubExpCoef(int pubExpCoef) {
		this.pubExpCoef = pubExpCoef;
	}

	public int getExamExpCoef() {
		return examExpCoef;
	}

	public void setExamExpCoef(int examExpCoef) {
		this.examExpCoef = examExpCoef;
	}

	public int getWizardRaidBossExpCoef() {
		return wizardRaidBossExpCoef;
	}

	public void setWizardRaidBossExpCoef(int wizardRaidBossExpCoef) {
		this.wizardRaidBossExpCoef = wizardRaidBossExpCoef;
	}

	public int getWizardRaidExpCoef() {
		return wizardRaidExpCoef;
	}

	public void setWizardRaidExpCoef(int wizardRaidExpCoef) {
		this.wizardRaidExpCoef = wizardRaidExpCoef;
	}

	public int getSealDemonExpCoef() {
		return sealDemonExpCoef;
	}

	public void setSealDemonExpCoef(int sealDemonExpCoef) {
		this.sealDemonExpCoef = sealDemonExpCoef;
	}

	public int getCalculateExpPubRewardId() {
		return calculateExpPubRewardId;
	}

	public void setCalculateExpPubRewardId(int calculateExpPubRewardId) {
		this.calculateExpPubRewardId = calculateExpPubRewardId;
	}

	public int getCalculateExpSealDemonRewardId() {
		return calculateExpSealDemonRewardId;
	}

	public void setCalculateExpSealDemonRewardId(int calculateExpSealDemonRewardId) {
		this.calculateExpSealDemonRewardId = calculateExpSealDemonRewardId;
	}

	public int getExamWrongAnswerCoef() {
		return examWrongAnswerCoef;
	}

	public void setExamWrongAnswerCoef(int examWrongAnswerCoef) {
		this.examWrongAnswerCoef = examWrongAnswerCoef;
	}

	public int getRingExpCoef() {
		return ringExpCoef;
	}

	public void setRingExpCoef(int ringExpCoef) {
		this.ringExpCoef = ringExpCoef;
	}

	public int getGuideSubSkillProQuestId() {
		return guideSubSkillProQuestId;
	}

	public void setGuideSubSkillProQuestId(int guideSubSkillProQuestId) {
		this.guideSubSkillProQuestId = guideSubSkillProQuestId;
	}

	public int getGuideMindLevelupQuestId() {
		return guideMindLevelupQuestId;
	}

	public void setGuideMindLevelupQuestId(int guideMindLevelupQuestId) {
		this.guideMindLevelupQuestId = guideMindLevelupQuestId;
	}

	public int getGuideSkillLevelupQuestId() {
		return guideSkillLevelupQuestId;
	}

	public void setGuideSkillLevelupQuestId(int guideSkillLevelupQuestId) {
		this.guideSkillLevelupQuestId = guideSkillLevelupQuestId;
	}

	public int getAddFriendLevel() {
		return addFriendLevel;
	}

	public void setAddFriendLevel(int addFriendLevel) {
		this.addFriendLevel = addFriendLevel;
	}
