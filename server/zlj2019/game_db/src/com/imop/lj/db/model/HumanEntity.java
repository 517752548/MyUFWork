...
public class HumanEntity implements BaseEntity<Long> {
	...
	/** 挂机点数量 */
	@Comment(content="免费挂机点数量")
	private long guaJiPoint;
	@Comment(content="充值挂机点数量")
	private long guaJiPoint2;
	
	@Comment(content="购买月卡时间")
	private long buyMonthCardTime;
	
	@Comment(content="非法请求战斗次数")
	private int invalidBattleNum;
...
//	}
	...
	public void setBuyMonthCardTime(long buyMonthCardTime) {
		this.buyMonthCardTime = buyMonthCardTime;
	}

	@Column(columnDefinition = " int(11) default 0", nullable = false)
	public int getInvalidBattleNum() {
		return invalidBattleNum;
	}

	public void setInvalidBattleNum(int invalidBattleNum) {
		this.invalidBattleNum = invalidBattleNum;
	}
