...
USE `tr_${server_id}`;
update t_db_version set version='1.0.0.33',updateTime=now();
delete from t_item_info where deleted=1;

alter table t_db_version add column serverNames text;
update t_db_version set serverNames='[\"${deployConfig.mergeName}\"]';

-- ----------------------------
-- Table structure for `t_escort_income`
-- ----------------------------
DROP TABLE IF EXISTS `t_escort_income`;
CREATE TABLE `t_escort_income` (
  `id` bigint(20) NOT NULL,
  `lastChangeTime` bigint(20) DEFAULT NULL,
  `receive` int(11) DEFAULT NULL,
  `roleId` bigint(20) DEFAULT NULL,
  `todayTotalReward` text,
  `yestodayTotalReward` text,
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_ship` (
  `id` bigint(20) NOT NULL,
  `attackedNum` int(11) DEFAULT NULL,
  `attackedSuccNum` int(11) DEFAULT NULL,
  `encourageValue` int(11) DEFAULT NULL,
  `eventId` int(11) DEFAULT NULL,
  `helperId` bigint(20) DEFAULT NULL,
  `lastAttackedTime` bigint(20) DEFAULT NULL,
  `line` int(11) DEFAULT NULL,
  `loseStr` text,
  `luckPack` text,
  `roleId` bigint(20) NOT NULL,
  `shipTmplId` int(11) DEFAULT NULL,
  `speedUpNum` int(11) DEFAULT NULL,
...
if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'goldShell') then  
        alter table tr_${server_id}.t_character_info drop column goldShell;
end if; 
alter table tr_${server_id}.t_character_info add column goldShell bigint(20) NOT NULL DEFAULT '0';
end;;
delimiter ';';
call schema_change();
drop procedure if exists schema_change;
