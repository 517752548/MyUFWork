...
USE `tr_${server_id}`;
update t_db_version set version='1.0.0.30',updateTime=now();
delete from t_item_info where deleted=1;

-- ----------------------------
-- Table structure for t_qq_markettask_target
-- ----------------------------
DROP TABLE IF EXISTS `t_qq_markettask_target`;
CREATE TABLE `t_qq_markettask_target` (
  `id` int(11) NOT NULL,
