 ...
 *
 */
public class LogReasonDataDictGenerator {
	/** 日志类 */
	private static final String LOG_REASON_CLAZZ = "com.imop.lj.common.LogReasons";
	/** 日志数据字典 */
	private static final String XLS_FILENAME =  System.getProperty("user.dir") + File.separator + "doc" + File.separator + "logReasonDataDict.xls";

	/**
	 * 类参数构造器
	 *
	 */
	public LogReasonDataDictGenerator() {
	}
	...
	public static void main(String[] args) {
		// 创建生成器并生成日志数据字典
		LogReasonDataDictGenerator generator;

		generator = new LogReasonDataDictGenerator();
		generator.generate();
