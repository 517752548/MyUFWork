 ...
 */
public class CGTeamCallBack extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_TEAM_CALL_BACK;
	}
	
	@Override
	public String getTypeName() {
		return "CG_TEAM_CALL_BACK";
	}
	...
	@Override
	public void execute() {
		TeamHandlerFactory.getHandler().handleTeamCallBack(this.getSession().getPlayer(), this);
	}
}