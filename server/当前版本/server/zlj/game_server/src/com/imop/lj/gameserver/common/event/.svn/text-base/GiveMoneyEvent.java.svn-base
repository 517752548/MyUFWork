...
public class GiveMoneyEvent extends Event<Human>{
	...
	private final static EventType eventType = EventType.GiveMoney;

	public GiveMoneyEvent(Human human, Currency currency, long amount) {
