...
public interface BattleDef {
	...
	/** 技能默认表现时间的最小值 */
	public static final int SKILL_PERFORM_TIME_MIN = 400;
	...
	/** 心法默认等级,1级*/
	public static final int DEFAULT_MAIN_SKILL_LEVEL = 1;
	/** 技能默认层数,1层*/
	public static final int DEFAULT_SUB_SKILL_LAYER = 1;
	/** 技能默认熟练度,0*/
	public static final int DEFAULT_SUB_SKILL_PROFICIENCY = 0;
	/** 快捷栏技能默认索引,-1代表没有上快捷栏*/
	public static final int DEFAULT_SUB_SKILL_SHORTCUT_INDEX = -1;
	/** 捕捉宠物技能id */
	...
	/** 技能熟练度*/
	public static final String SUB_SKILL_PROFICIENCY = "proficiency";
...
//		ACTION_DEFENCE_AFTER(42),
	 ...
	 *
	 */
	public enum LabelCatalog implements IndexedEnum {
		NONE(0),
		/** 侠义之心*/
		CHIVALRIC(1),
		;
		...
		private LabelCatalog(int index) {
			this.index = index;
		}
		
		private static final List<LabelCatalog> values = IndexedEnumUtil.toIndexes(LabelCatalog.values());
		
		public static LabelCatalog valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
	}
...
//		SUPPORT(3, new SupportConvertor()),
	 ...
	 *
	 */
	public enum BuffLabel implements IndexedEnum{
		/** 诅咒 */
		CURSE(1), 
		/** 法术敏感 */
		MAGIC_INSENSITIVE(2),
		...
		private BuffLabel(int index) {
			this.index = index;
		}
		
		private static final List<BuffLabel> values = IndexedEnumUtil.toIndexes(BuffLabel.values());
		
		public static BuffLabel valueOf(int index) {
			return EnumUtil.valueOf(values, index);
		}
