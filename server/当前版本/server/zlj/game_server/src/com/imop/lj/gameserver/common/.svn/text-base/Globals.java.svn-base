...
import com.imop.lj.gameserver.charge.MonthCardService;
...
import com.imop.lj.gameserver.exchange.ExchangeService;
...
import com.imop.lj.gameserver.guaji.GuaJiService;
...
import com.imop.lj.gameserver.lifeskill.LifeSkillService;
...
import com.imop.lj.gameserver.ringtask.RingTaskService;
...
import com.imop.lj.gameserver.xianhu.XianhuService;
...
//	private static DirtFilterService dirtFilterService;
     ...
     * 月卡服务
     */
    private static MonthCardService monthCardService;
    /**
     * 角色辅助管理器
     */
     ...
     * 挂机
     */
    private static GuaJiService guaJiService;
    
    /**
     * 生活技能
     */
    private static LifeSkillService lifeSkillService;
     ...
     * 跑环任务服务
     */
    private static RingTaskService ringTaskService;
	...
	/** 仙葫服务 */
	private static XianhuService xianhuService;
...
//		moduleDataService.init();
        ...
        monthCardService = new MonthCardService();
        monthCardService.init();
        ...
        lifeSkillService = new LifeSkillService();
        lifeSkillService.init();
        ...
        ringTaskService = new RingTaskService();
        ringTaskService.init();
        ...
        //新手引导服务
 		...
 		//仙葫服务
 		xianhuService = new XianhuService();
 		xianhuService.init();
    ...
    private static UUIDService buildUUIDService(DBService dbServices,
        ...
        UUIDType[] _types = new UUIDType[]{UUIDType.HUMAN, UUIDType.PET, UUIDType.SCENE,
                ...
                UUIDType.XIANHU_RANK, UUIDType.XIANHU,
        };
...
//	}
    ...
    public static MonthCardService getMonthCardService() {
	...
	public static GuaJiService getGuaJiService() {
		return guaJiService;
	}

	public static LifeSkillService getLifeSkillService() {
		return lifeSkillService;
	}
	...
	public static RingTaskService getRingTaskService() {
		return ringTaskService;
	}
	...
	public static XianhuService getXianhuService() {
		return xianhuService;
	}
