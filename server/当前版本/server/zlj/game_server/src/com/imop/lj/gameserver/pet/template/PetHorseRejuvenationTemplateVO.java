...
@ExcelRowBinding
public abstract class PetHorseRejuvenationTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetHorseRejuvenationTemplateVO[petpetTypeId=" + petpetTypeId + ",itemId=" + itemId + ",itemNum=" + itemNum + ",currencyNum=" + currencyNum + ",currencyType=" + currencyType + ",name=" + name + ",]";
