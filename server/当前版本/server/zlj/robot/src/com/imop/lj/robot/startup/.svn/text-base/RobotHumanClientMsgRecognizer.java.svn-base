...
public class RobotHumanClientMsgRecognizer implements MessageMappingProvider {
	...
	public Map<Short, Class<?>> getMessageMapping() {
		...
		msgs.put(MessageType.GC_XIANHU_PANEL, GCXianhuPanel.class);
		msgs.put(MessageType.GC_XIANHU_RANK_LIST, GCXianhuRankList.class);
		msgs.put(MessageType.GC_MONTH_CARD_INFO, GCMonthCardInfo.class);
		return msgs;
	}
}
