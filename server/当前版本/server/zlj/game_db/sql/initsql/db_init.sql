...
-- DROP DATABASE IF EXISTS `tr_${server_id}_battle_report`;
CREATE DATABASE `tr_${server_id}_battle_report` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tr_${server_id}_battle_report`;

-- DROP DATABASE IF EXISTS `tr_${server_id}`;
CREATE DATABASE `tr_${server_id}` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tr_${server_id}`;
...
CREATE TABLE `t_character_info` (
  ...
  `goldShell` bigint(20) NOT NULL DEFAULT '0',
  `orangeHufu` bigint(20) NOT NULL DEFAULT '0',
  `swordSoul` bigint(20) DEFAULT '0',
  `swordSoul1` bigint(20) DEFAULT '0',
  `swordSoul2` bigint(20) DEFAULT '0',
  `swordSoul3` bigint(20) DEFAULT '0',
  `swordSoul4` bigint(20) DEFAULT '0',
  `swordSoul5` bigint(20) DEFAULT '0',
  `swordSoul6` bigint(20) DEFAULT '0',
  `swordSoul7` bigint(20) DEFAULT '0',
  `zuanshibi` bigint(20) DEFAULT '0',
  `monsterSoul` bigint(20) DEFAULT '0',
  `weekCharge` int(11) NOT NULL DEFAULT '0',
  `monthCharge` int(11) NOT NULL DEFAULT '0',
  `fumoshiChip` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
...
INSERT INTO `t_db_version` VALUES (1,'2014-08-11 16:56:33','2013-03-08 14:00:00','2014-09-06 19:39:36','1.0.0.47','[${deployConfig.localHostId}]','[\"${deployConfig.mergeName}\"]');
...
INSERT INTO `t_dirtywords` VALUES (1,0,'2014-08-11 16:56:33');
...
-- log日志
-- DROP DATABASE IF EXISTS `tr_${server_id}_log`;
CREATE DATABASE `tr_${server_id}_log` DEFAULT CHARACTER SET utf8  COLLATE utf8_general_ci;
USE `tr_${server_id}_log`;

-- ----------------------------
DROP TABLE IF EXISTS `tr_${server_id}_log`.`reason_list`;
-- ----------------------------
...
-- --accessory_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (553,'accessory_log','饰品日志','reason',1,'立即强化');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (553,'accessory_log','饰品日志','reason',2,'普通强化');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (553,'accessory_log','饰品日志','reason',3,'饰品升阶');
-- --accessory_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (546,'armour_log','战甲日志','reason',2,'战甲套装日志');
-- --armour_log end----

-- --army_title_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (538,'army_title_log','军衔log','reason',1,'军衔增加记录');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (538,'army_title_log','军衔log','reason',3,'领取军衔俸禄记录');
-- --army_title_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (545,'bank_log','钱庄日志','reason',7,'周卡钱庄过期日志');
-- --bank_log end----
...
-- --classic_battle_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',1,'创建经典战役大地图关卡');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',2,'进入经典战役大地图关卡');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',3,'离开经典战役大地图关卡');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',4,'攻击关卡');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',5,'查看奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',6,'打开宝箱');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',7,'购买进入次数');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',8,'购买行动力');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',9,'攻击关卡怪物结果');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (554,'classic_battle_log','经典战役日志','reason',10,'经典战役通关');
-- --classic_battle_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (521,'corps_log','军团','reason',27,'GM解散');
-- --corps_log end----
...
-- --escort_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',1,'开始渡江');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',2,'免费刷新船只');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',3,'物品刷新船只');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',4,'付费刷新船只');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',5,'元宝鼓舞');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',6,'免费占卜');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',7,'付费占卜');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',8,'直接购买');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',9,'物品直接购买');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',10,'取消所有邀请');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',11,'借东风: 开启者ID = {0}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',12,'清除抢夺CD');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',13,'冲刺十分钟');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',14,'立即结束');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',15,'领取排行奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',16,'购买抢夺次数');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',17,'抢夺船只');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',18,'邀请好友');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',19,'邀请结果');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',20,'零点排行');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',21,'航行结束');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',22,'借东风结束');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',23,'抢夺收益 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',24,'抢夺损失');
-- --escort_log end----

-- --everyday_charge_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (551,'everyday_charge_log','每日首充日志','reason',1,'领取每日首充奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (551,'everyday_charge_log','每日首充日志','reason',2,'每日首充过期发邮件');
-- --everyday_charge_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (544,'every_day_target_log','每日必做日志','reason',2,'每日必做领取活跃奖励');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (517,'formation_log','布阵','reason',4,'阵内交换');
-- --formation_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (524,'hero_mission_log','过关斩将','reason',10,'攻击试剑塔');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (524,'hero_mission_log','过关斩将','reason',11,'攻击试剑塔结果');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (524,'hero_mission_log','过关斩将','reason',12,'经典战役打怪物');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (524,'hero_mission_log','过关斩将','reason',13,'攻击试剑塔结果');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',50,'装备批量附魔消耗');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',123,'技能书合成');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',318,'立即完成一环任务消耗道具');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',319,'全部完成环任务消耗道具');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',320,'qq-被邀请者n天奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',321,'qq-充值返利奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',322,'qq-邀请好友次数奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',323,'qq-历程分享奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',324,'qq-每日邀请好友奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',325,'qq-app评分奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',326,'qq-集市任务奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',327,'每日首充奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',328,'船只刷新消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',329,'船只直接购买消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',330,'渡江单次攻击');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',331,'渡江完成');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',332,'借东风开启奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',333,'借东风结束奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',334,'抢夺收益排名奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',335,'抢夺收益排名超级奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',336,'渡江护送完成 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',337,'领取CDKEY礼包 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',338,'试剑塔关卡敌人奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',339,'经典战役通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',340,'经典战役事件奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',341,'经典战役自动通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',342,'饰品强化消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',343,'饰品立即强化消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',344,'饰品升阶消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',345,'饰品升阶增加');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',346,'饰品升阶删除');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (508,'item_log','物品更新','reason',348,'演武离线打坐获得经验');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',40,'招募武将消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',41,'解雇武将返还');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',982,'立即完成单环任务, 消耗元宝{0}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',983,'全部完成环任务, 消耗元宝{0}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',990,'qq-被邀请者n天奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',991,'qq-充值返利奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',992,'qq-邀请好友次数奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',993,'qq-历程分享奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',994,'qq-每日邀请好友奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',995,'qq-app评分奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',996,'qq-集市任务奖励');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1000,'渡江加速消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1001,'清除抢夺CD');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1002,'船只刷新：刷新次数{0}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1003,'船只直接购买');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1004,'鼓舞消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1005,'占卜消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1006,'开启借东风');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1007,'渡江单次攻击');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1008,'立即结束消耗');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1009,'渡江完成');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1010,'借东风开启奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1011,'借东风结束奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1012,'抢夺收益排名奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1013,'抢夺收益排名超级奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1014,'渡江护送完成 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1015,'购买抢夺次数 ');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1020,'饰品强化消耗 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1021,'饰品立即强化消耗 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1022,'饰品升阶消耗 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1100,'试剑塔召唤剑气花费元宝');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1101,'试剑塔召唤获得剑气');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1102,'试剑塔拉杆获得剑气');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1103,'试剑塔关卡敌人奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1201,'经典战役通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1202,'经典战役事件奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1203,'经典战役自动通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1204,'经典战役购买副本进入次数');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1205,'经典战役关卡购买行动力');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1210,'剑气升级扣除普通剑气');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1211,'剑气升级扣除替换剑气');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1212,'武将解雇返还');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',45,'副将经验卡');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',46,'在线礼包');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',68,'qq-被邀请者n天奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',69,'qq-充值返利奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',70,'qq-邀请好友次数奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',71,'qq-历程分享奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',72,'qq-每日邀请好友奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',73,'qq-app评分奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',74,'qq-集市任务奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',75,'每日首充奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',76,'渡江单次攻击');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',77,'渡江完成');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',78,'借东风开启奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',79,'借东风结束奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',80,'抢夺收益排名奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',81,'抢夺收益排名超级奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',82,'渡江护送完成 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',83,'领取CDKEY礼包 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',84,'试剑塔关卡敌人奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',85,'经典战役通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',86,'经典战役事件奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',87,'经典战役自动通关奖励');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',88,'特殊在线礼包');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',89,'演武在线打坐获得经验');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',90,'演武离线打坐获得经验');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (534,'pet_exp_log','经验','reason',91,'累积消耗');
-- --pet_exp_log end----
...
-- --practice_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (556,'practice_log','演武日志','reason',1,'在线演武开始');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (556,'practice_log','演武日志','reason',2,'在线演武结束');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (556,'practice_log','演武日志','reason',3,'离线演武经验');
-- --practice_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (520,'reward_log','奖励日志','reason',3,'通过军团分配生成的奖励');
-- --reward_log end----
...
-- --sword_soul_log begin----
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (555,'sword_soul_log','剑气日志','reason',1,'剑气激活');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (555,'sword_soul_log','剑气日志','reason',2,'剑气互换');
-- --sword_soul_log end----
