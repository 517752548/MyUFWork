 ...
 */
@Entity
@Table(name = "t_task_thesweeney")
@Comment(content="数据库实体类：除暴安良任务表")
public class TheSweeneyTaskEntity implements BaseEntity<String>, CharSubEntity {
	/** */
