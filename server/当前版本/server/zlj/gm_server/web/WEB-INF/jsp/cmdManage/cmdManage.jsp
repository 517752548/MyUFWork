...
<div id="man_zone">
<div class="topnav">
<a class="link" href="homePage.do?action=welcome"><%= lang.readGm(GMLangConstants.WEL_HOME_PAGE) %></a>>><%= lang.readGm(GMLangConstants.DAILY_MAINTENANCE) %>>><%= lang.readGm(GMLangConstants.CMD_MANAGE) %>
</div>
<br/>
<c:choose>
...
<br/>
<div class="nofloat"/>
<form action="cmd.do?action=sendCmd" method="post">
