...
public class LangConstants {
	...
	@SysI18nString(content = "该宠物寿命值过低，不能出战！")
	public static final Integer PET_FIGHT_FAIL_NOT_ENOUGH_LIFE = ++PET_BASE;
	@SysI18nString(content = "道具不足，不能重洗天赋技能！")
	...
	@SysI18nString(content = "等级不足,不能洗资质！")
	public static final Integer PET_REJUVEN_LEVEL_DEFICI = ++PET_BASE;
	...
	@SysI18nString(content = "骑宠丹不足，无法提升！")
	...
	@SysI18nString(content = "骑宠忠诚度过低,无法出站！")
...
//	private static Integer LANDLORD_BASE = 43000;
	...
	@SysI18nString(content = "升级成功{0}个，升级失败{1}个,返还 道具/货币 数量{2}个!")
	...
	/** 过关斩将 45000 */
	private static Integer HERO_MISSION_BASE = 45000;
	@SysI18nString(content = "金子不足，不能重置！")
	public static final Integer HERO_MISSION_RESET_NOT_ENOUGH_BOND = ++HERO_MISSION_BASE;
	@SysI18nString(content = "名将试炼单次重置")
	public static final Integer HERO_MISSION_RESET = ++HERO_MISSION_BASE;
	@SysI18nString(content = "名将试炼章节重置")
	public static final Integer HERO_MISSION_RESET_STAGE = ++HERO_MISSION_BASE;
	@SysI18nString(content = "您确定消耗{0}金子重置本关？")
	public static final Integer HERO_MISSION_RESET_CONFIRM = ++HERO_MISSION_BASE;
	@SysI18nString(content = "您确定消耗{0}金子重置本章节所有可重置关？")
	public static final Integer HERO_MISSION_RESET_STAGE_CONFIRM = ++HERO_MISSION_BASE;
	
	/** 世界boss战 46000 */
	private static Integer BOSSWAR_WORLD_BASE = 46000;
	@SysI18nString(content = "攻击加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_ATTACK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "暴击加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_FATAL = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "魔化的")
	public static final Integer BOSSWAR_WORLD_NAME_MALE_PREFIX = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "妖化的")
	public static final Integer BOSSWAR_WORLD_NAME_FEMALE_PREFIX = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "金子不足，不能立即复活！")
	public static final Integer BOSSWAR_WORLD_KILL_CD_NOT_ENOUGH_MONEY = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "九州降魔立即复活")
	public static final Integer BOSSWAR_WORLD_REVIVE = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "是否花费{0}金子立即复活？")
	public static final Integer BOSSWAR_WORLD_REVIVE_CONFIRM = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "激励效果已达上限！")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_FAIL_TIMES_LIMIT = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "九州降魔攻击激励")
	public static final Integer BOSSWAR_WORLD_ENCOURGE_ATTACK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "是否花费{0}金子提升{1}%攻击？")
	public static final Integer BOSSWAR_WORLD_ENCOURGE_ATTACK_CONFIRM = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "九州降魔暴击激励")
	public static final Integer BOSSWAR_WORLD_ENCOURGE_FATAL = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "是否花费{0}金子提升{1}%暴击？")
	public static final Integer BOSSWAR_WORLD_ENCOURGE_FATAL_CONFIRM = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "金子不足，不能进行激励！")
	public static final Integer BOSSWAR_WORLD_ENCOURGE_FAIL_NOT_ENOUGH_MONEY = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "致命一击，你成功击杀了BOSS！")
	public static final Integer BOSSWAR_WORLD_KILL_BOSS_REPORT_DESC = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "魔神已被击败。")
	public static final Integer BOSSWAR_WORLD_BOSS_DEFEATED = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "魔神已撤退。")
	public static final Integer BOSSWAR_WORLD_BOSS_NOT_DEFEATED = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "本次九州降魔中，你总共造成伤害{0}，占总伤害{1}%，累计获得{2}，排名第{3}")
	public static final Integer BOSSWAR_WORLD_BOSS_END_NOTICE_RANK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "本次九州降魔中，你总共造成伤害{0}，占总伤害{1}%，累计获得{2}，未进入排名")
	public static final Integer BOSSWAR_WORLD_BOSS_END_NOTICE_NO_RANK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "本次九州降魔中，<br/>你排名第{0}名。")
	public static final Integer BOSSWAR_WORLD_BOSS_RANK_REWARD_STR = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "被BOSS击败。")
	public static final Integer BOSSWAR_WORLD_LOSS_REPORT_DESC = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "激励成功！")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_OK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "VIP不满足要求，不能使用该功能！")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_FAIL_VIP_LIMIT = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "力量攻击加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_STRENGTH_ATTACK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "策略攻击加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_INTELLECT_ATTACK = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "血量加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_HP = ++BOSSWAR_WORLD_BASE;
	@SysI18nString(content = "士气加成")
	public static final Integer BOSSWAR_WORLD_ENCOURAGE_NAME_ANGER = ++BOSSWAR_WORLD_BASE;
	
//	/** 神器 47000 */
//	private static Integer TREASURE_BASE = 47000;
...
//	private static Integer QQ = 70000;
	...
	@SysI18nString(content = "心法等级已经达到上线或未开启")
	...
	@SysI18nString(content = "技能等级不能大于角色等级")
	public static final Integer SUBSKILL_LEVE_BIGGER_THAN_HUMAN_LEVEL = ++HUMANSKILL;
	...
	@SysI18nString(content = "仙踪林副本中一只怪物未在一分钟内击杀，变为【{0}】！")
