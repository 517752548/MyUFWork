package com.imop.lj.core.script.impl;
...
import com.imop.lj.core.script.IScriptEngine;
...
//			System.out.println("script:"+s.getEngineName());
//		}
		engine = factory.getEngineByName("JavaScript");
//		System.out.println("script:"+engine.getClass().getName());
	}
	...
	public Object runScript(Map<String, Object> binding, String scriptFile, String charset) {
		...
		try {
			...
			throw new RuntimeException(ErrorsUtil.error(com.imop.lj.common.constants.CommonErrorLogInfo.FILE_IO_FAIL, "Throw Exception",
					scriptFile), e);
		} catch (ScriptException se) {
			throw new RuntimeException(ErrorsUtil.error(com.imop.lj.common.constants.CommonErrorLogInfo.SCRITP_EXECUTE_FAIL,
