...
USE `tr_${server_id}`;
update t_db_version set version='1.0.0.40',updateTime=now();
...
if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_turntable_activity' and column_name = 'fType') then  
        alter table tr_${server_id}.t_turntable_activity drop column fType;
end if; 
alter table tr_${server_id}.t_turntable_activity add column fType int(11) NOT NULL DEFAULT 0;
...
alter table tr_${server_id}.t_db_version add column tmpMergeFlag int(11) NOT NULL DEFAULT 0;

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'weekCharge') then  
        alter table tr_${server_id}.t_character_info drop column weekCharge;
end if; 
alter table tr_${server_id}.t_character_info add column weekCharge int(11) NOT NULL DEFAULT 0;

if exists (select * from information_schema.columns where table_schema='tr_${server_id}' and table_name = 't_character_info' and column_name = 'monthCharge') then  
        alter table tr_${server_id}.t_character_info drop column monthCharge;
end if; 
alter table tr_${server_id}.t_character_info add column monthCharge int(11) NOT NULL DEFAULT 0;
...
update t_turntable_activity set fType=1;
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',17,'抢夺船只:攻击者={0}, 被攻击者={1}, 结果={2}');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',19,'邀请结果:邀请人={0}, 结果={2}');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',23,'抢夺收益 : attackId = {0}, targetId = {1}, income = {2}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (552,'escort_log','赤壁渡江日志','reason',24,'抢夺损失 : attackId = {0}, targetId = {1}, lose income = {2}');
-- --escort_log end----
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1005,'船只刷新：刷新次数{0}');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1005,'船只直接购买');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1005,'鼓舞消耗');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1006,'清除抢夺CD');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1008,'渡江加速消耗');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1020,'饰品立即强化消耗 ');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1021,'饰品升阶消耗 ');
...
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1210,'剑气升级扣除替换剑气');
insert into reason_list(log_type,log_table,log_desc,log_field,reason,reason_name) values (510,'money_log','金钱改变','reason',1211,'武将解雇返还');
