...
CREATE TABLE `t_character_info` (
  ...
  `lastGiveSkillPointTime` bigint(20) DEFAULT '0',
  `skillPoint` int(11) DEFAULT '0',
  `mapId` int(11) DEFAULT '0',
  `x` int(11) DEFAULT '0',
  `y` int(11) DEFAULT '0',
  `lastBattleId` int(11) DEFAULT '0',
  `lastBattleTime` bigint(20) DEFAULT '0',
  `lastBattleEndTime` bigint(20) DEFAULT '0',
  `autoFightAction` int(11) DEFAULT '0',
  `petAutoFightAction` int(11) DEFAULT '0',
  `pubExp` bigint(20) DEFAULT '0',
  `pubLevel` int(11) DEFAULT '0',
  `mainSkillLevel` int(11) DEFAULT '1',
  `mainSkillType` int(11) DEFAULT '0',
  `levelUpTimeStamp` bigint(20) DEFAULT '0',
  `energy` int(11) DEFAULT '0',
  `mineLevel` int(11) DEFAULT '1',
  `gold2` bigint(20) DEFAULT '0',
  `backMapId` int(11) DEFAULT '0',
  `backX` int(11) DEFAULT '0',
  `backY` int(11) DEFAULT '0',
  `lastGiveDoublePointTime` bigint(20) DEFAULT '0',
...
CREATE TABLE `t_user_offline` (
  ...
  `curDoublePoint` int(11) NOT NULL DEFAULT '0',
  ...
  `isOpenDouble` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `t_user_snap` (
  ...
  `funcPack` text,
  `level` int(11) NOT NULL DEFAULT '0',
  `mindId` int(11) NOT NULL DEFAULT '0',
  `mindLevel` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) DEFAULT NULL,
  `passportId` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_db_version` VALUES ('1', '2016-03-24 16:56:33', '2016-03-24 14:00:00', '2016-03-24 19:39:36', '1.0.0.1', '[1002]', '[\"ts002\"]');
