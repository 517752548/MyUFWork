...
@ExcelRowBinding
public abstract class CorpsBossCountRankTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "CorpsBossCountRankTemplateVO[rank=" + rank + ",rewardId=" + rewardId + ",mailTitle=" + mailTitle + ",mailContent=" + mailContent + ",showRewardName=" + showRewardName + ",showRewardId=" + showRewardId + ",]";
