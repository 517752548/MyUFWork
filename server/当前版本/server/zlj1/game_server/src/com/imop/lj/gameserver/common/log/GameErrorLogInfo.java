...
public class GameErrorLogInfo extends CommonErrorLogInfo {
	...
	/** 充金币订单号异常 */
	public static final String CHARGE_DIAMOND_ORDER_ID_FAIL = "CHARGE.ORDER.ID.ERR";
	/** 充元宝接口异常 */
	public static final String CHARGE_YUANBAO_INVOKE_FAIL = "CHARGE.YUANBAO.ERR.INVOKEFAIL";
