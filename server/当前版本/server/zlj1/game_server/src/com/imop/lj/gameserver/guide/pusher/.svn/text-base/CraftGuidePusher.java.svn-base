...
public class CraftGuidePusher extends AbstractGuidePusher {
	
	public CraftGuidePusher() {
		super(GuideType.CRAFT);
	}
	...
	public boolean checkCond(Human human) {
		...
		//是否完成了指定的任务
		return human.getCommonTaskManager().isFinished(Globals.getGameConstants().getGuideCraftQuestId());
	}
