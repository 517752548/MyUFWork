...
@ExcelRowBinding
public abstract class PetTrainPropTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "PetTrainPropTemplateVO[trainTypeId=" + trainTypeId + ",minusFlag=" + minusFlag + ",propMin=" + propMin + ",propMax=" + propMax + ",weight=" + weight + ",]";
