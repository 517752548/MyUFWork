...
//		entity.setFriendPack(friendMapToJson());
		...
		entity.setCurDoublePoint(this.curDoublePoint);
		entity.setIsOpenDouble(this.isOpenDouble);
...
//		this.friendMapFromJson(entity.getFriendPack());
		...
		this.curDoublePoint = entity.getCurDoublePoint();
		this.isOpenDouble = entity.getIsOpenDouble();
