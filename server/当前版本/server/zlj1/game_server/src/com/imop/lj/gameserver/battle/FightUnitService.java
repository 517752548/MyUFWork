...
//		amendList.add(new MindFightUnitAmend());
	...
	public FightUnit createFightUnit(Pet pet, int battleIndex, String id, 
		...
		FightUnit unit = PetHelper.createFightUnit(pet, battleIndex, id, isAttacker);
	...
	public FightUnit createFightUnitByPetSnap(UserSnap userSnap, PetBattleSnap petSnap, 
			int battleIndex, String id, BattleTypeTemplate battleTypeTemplate, boolean isAttacker) {
		FightUnit unit = PetHelper.createFightUnitByPetSnap(userSnap, petSnap, battleIndex, id, isAttacker);
