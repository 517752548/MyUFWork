...
@ExcelRowBinding
public abstract class ForageTaskLevelTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "ForageTaskLevelTemplateVO[levelMin=" + levelMin + ",levelMax=" + levelMax + ",questGroupId=" + questGroupId + ",]";
