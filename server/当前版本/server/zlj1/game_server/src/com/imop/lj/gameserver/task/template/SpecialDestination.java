...
public class SpecialDestination {
	...
	public void check(int questId) {
		...
		case NULL:
			break;
		case NUM_RECORD:
			checkNumRecordDest(questId, Integer.parseInt(param1st), Integer.parseInt(param2nd), Integer.parseInt(param3rd));
			break;
		case LEADER_LEVEL_A:
	...
	public List<IQuestDestination> buildQuestDestination(int questId) {
		...
		case NULL:
			...
			break;
		case NUM_RECORD:
			dests.add(new NumRecordDest(questId, NumRecordType.indexOf(Integer.parseInt(param1st)), Integer.parseInt(param2nd), Integer.parseInt(param3rd)));
			break;
		case LEADER_LEVEL_A:
			dests.add(new LeaderLevelADest(questId, Integer.parseInt(param1st)));
			break;
		case COLLECTION_ITEM:
			dests.add(new ColletionItemDest(questId, Integer.parseInt(param1st), Integer.parseInt(param2nd)));
			break;
		case LEADER_MIND_LEVEL_A:
	...
	public void checkNumRecordDest(int questId, int numRecordTypeId, int targetId, int num) {
		// 检查计数类型是否存在
