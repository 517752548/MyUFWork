...
public abstract class MapTemplateVO extends TemplateObject {
	...
	public String toString() {
		return "MapTemplateVO[nameLangId=" + nameLangId + ",name=" + name + ",mapTypeId=" + mapTypeId + ",mapLevel=" + mapLevel + ",openLevel=" + openLevel + ",icon=" + icon + ",music=" + music + ",width=" + width + ",height=" + height + ",initX=" + initX + ",initY=" + initY + ",meetMonsterPlanId=" + meetMonsterPlanId + ",meetMonsterAddProb=" + meetMonsterAddProb + ",pvpFlag=" + pvpFlag + ",treasureMap=" + treasureMap + ",guajiFlag=" + guajiFlag + ",]";
