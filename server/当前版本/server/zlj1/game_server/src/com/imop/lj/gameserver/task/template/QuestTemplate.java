...
public class QuestTemplate extends QuestTemplateVO {
	...
	public void patchUp() {
		...
		// 组装任务目标
		List<IQuestDestination> tmpDests = specialDestination.buildQuestDestination(id);
	...
	public String getHotLinkContent(){
		String hotLinkContent = this.specialDestination.getParam5th();
