		...
		try {
			...
			while (_lastLoginTimeTp < _lastLogoutTimeTp) {
				...
				OnlineTimeLog _onlineTimeLog = new OnlineTimeLog(onlineTimeLog
						...
						onlineTimeLog.getServerId(), 
						onlineTimeLog.getAccountId(),
						onlineTimeLog.getAccountName(), 
						onlineTimeLog.getCharId()
						, onlineTimeLog.getCharName(),
						onlineTimeLog.getLevel(), 
						onlineTimeLog.getCountryId(),
						onlineTimeLog.getVipLevel(),
						onlineTimeLog.getTotalCharge()
						,onlineTimeLog.getDeviceId()
						, onlineTimeLog.getDeviceType()
						, onlineTimeLog.getDeviceVersion()
						, onlineTimeLog.getClientVersion()
						, onlineTimeLog.getClientLanguage()
						, onlineTimeLog.getAppid()
						, onlineTimeLog.getfValue()
						, onlineTimeLog.getReason()
						, onlineTimeLog.getParam()		
						,_totalMinuteInOneDay, _totalMinuteToOneDay,
						onlineTimeLog.getLastLoginTime(), 
						onlineTimeLog.getLastLogoutTime()
						);
