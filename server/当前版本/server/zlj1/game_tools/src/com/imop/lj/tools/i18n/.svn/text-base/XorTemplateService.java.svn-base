...
import com.imop.lj.core.template.LevelRangeValidater;
 ...
 *
 */
public class XorTemplateService extends TemplateService {
	...
	public XorTemplateService(String resourceFolder) {
		this(resourceFolder, true);
	}

	public XorTemplateService(String resourceFolder, boolean isXorLoad) {
		super(resourceFolder,isXorLoad);
