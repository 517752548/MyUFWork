 ...
 *
 */
public class BasicLogDAO extends GenericDAO{
	...
	public List getLogList(final String roleID, final String date,
			final long begin_time, final long end_time, final String sortType, final String order, final String reason,
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List getAutoLogList(final String roleID, final String date,
			final long begin_time, final long end_time, final String sortType, final String order, final String reason,
			final String logType) {
		return getTemplate().doCall(new HibernateCallback<List>() {
			@Override
