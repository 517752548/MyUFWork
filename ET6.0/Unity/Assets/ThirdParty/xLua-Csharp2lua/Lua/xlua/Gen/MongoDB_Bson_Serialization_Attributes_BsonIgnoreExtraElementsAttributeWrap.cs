        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MongoDB.Bson.Serialization.Attributes.BsonIgnoreExtraElementsAttribute();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new MongoDB.Bson.Serialization.Attributes.BsonIgnoreExtraElementsAttribute(_ignoreExtraElements);
					translator.Push(L, gen_ret);
